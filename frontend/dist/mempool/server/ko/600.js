    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "\uC774 \uCC44\uB110\uC740 \uBB34\uB8CC \uAE30\uBCF8 \uC218\uC218\uB8CC \uB77C\uC6B0\uD305\uC744 \uC9C0\uC6D0\uD569\uB2C8\uB2E4";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "\uC774 \uCC44\uB110\uC740 \uBB34\uB8CC \uAE30\uBCF8 \uC218\uC218\uB8CC \uB77C\uC6B0\uD305\uC744 \uC9C0\uC6D0\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4";
        }
        let i18n_9;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.switchMap)(params => {
        ...
        return this.lightningApiService.getChannel$(params.get('short_id')).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.tap)(value => {
          this.seoService.setTitle("\uCC44\uB110: " + value.short_id + "");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "\uB77C\uC6B0\uD305 \uB178\uB4DC\uAC00 \uBD80\uACFC\uD558\uB294 \uD3C9\uADE0 \uC218\uC218\uB8CC\uC728, \uC218\uC218\uB8CC\uC728\uC774 0.5% \uB610\uB294 5000ppm\uC744 \uCD08\uACFC\uD558\uB294 \uACBD\uC6B0\uB294 \uBB34\uC2DC\uD55C \uAC12";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_3 = "\uB77C\uC6B0\uD305 \uB178\uB4DC\uAC00 \uBD80\uACFC\uD558\uB294 \uD3C9\uADE0 \uAE30\uBCF8 \uC218\uC218\uB8CC, \uAE30\uBCF8 \uC218\uC218\uB8CC\uAC00 5000ppm\uC744 \uCD08\uACFC\uD558\uB294 \uACBD\uC6B0\uB294 \uBB34\uC2DC\uD55C \uAC12";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "\uB77C\uC6B0\uD305 \uB178\uB4DC\uAC00 \uBD80\uACFC\uD558\uB294 \uC218\uC218\uB8CC\uC728\uC758 \uC911\uAC04\uAC12, \uC218\uC218\uB8CC\uC728\uC774 0.5% \uB610\uB294 5000ppm\uC744 \uCD08\uACFC\uD558\uB294 \uACBD\uC6B0\uB294 \uBB34\uC2DC\uD55C \uAC12";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_11 = "\uB77C\uC6B0\uD305 \uB178\uB4DC\uAC00 \uBD80\uACFC\uD558\uB294 \uAE30\uBCF8 \uC218\uC218\uB8CC\uC758 \uC911\uAC04\uAC12, \uAE30\uBCF8 \uC218\uC218\uB8CC\uAC00 5000ppm\uC744 \uCD08\uACFC\uD558\uB294 \uACBD\uC6B0\uB294 \uBB34\uC2DC\uD55C \uAC12";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let LightningDashboardComponent = /*#__PURE__*/(() => {
  class LightningDashboardComponent {
    ...
    ngOnInit() {
      this.onResize();
      this.seoService.setTitle("\uB77C\uC774\uD2B8\uB2DD \uD0D0\uC0C9\uAE30");
    ...
    prepareChartOptions(outgoingData, incomingData) {
      ...
      if (sum === 0) {
        title = {
          ...
          text: "\uC544\uC9C1 \uD45C\uC2DC\uD560 \uB370\uC774\uD130\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4. \uB098\uC911\uC5D0 \uB2E4\uC2DC \uC2DC\uB3C4\uD574\uC8FC\uC138\uC694.",
          left: 'center',
          top: 'center'
        };
      }
  ...
  class NodeComponent {
    ...
    ngOnInit() {
      this.node$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_22__.switchMap)(params => {
        ...
        this.seoService.setTitle("\uB178\uB4DC: " + node.alias + "");
        this.seoService.setDescription("Overview for the Lightning network node named " + node.alias + ". See channels, capacity, location, fee stats, and more.");
        this.clearnetSocketCount = 0;
        this.torSocketCount = 0;
        const socketsObject = [];
...
let NodesChannelsMap = /*#__PURE__*/(() => {
  class NodesChannelsMap {
    ...
    ngOnInit() {
      ...
      if (this.style === 'graph') {
        this.center = [0, 5];
        this.seoService.setTitle("\uB77C\uC774\uD2B8\uB2DD \uB178\uB4DC \uCC44\uB110 \uC138\uACC4\uC9C0\uB3C4");
...
let NodesMap = /*#__PURE__*/(() => {
  class NodesMap {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("\uB77C\uC774\uD2B8\uB2DD \uB178\uB4DC \uC138\uACC4\uC9C0\uB3C4");
  ...
  class NodesNetworksChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("\uB124\uD2B8\uC6CC\uD06C\uB2F9 \uB77C\uC774\uD2B8\uB2DD \uB178\uB4DC");
...
let NodesPerCountryChartComponent = /*#__PURE__*/(() => {
  class NodesPerCountryChartComponent {
    ...
    ngOnInit() {
      this.seoService.setTitle("\uAD6D\uAC00\uBCC4 \uB77C\uC774\uD2B8\uB2DD \uB178\uB4DC \uC218");
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${country.name.en} (${country.share}%)</b><br>` + "" + nodeCount + "\uAC1C \uB178\uB4DC" + `<br>` + "" + this.amountShortenerPipe.transform(country.capacity / 100000000, 2) + " BTC \uC6A9\uB7C9";
            }
          },
          data: country.iso
        });
      ...
      data.push({
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Other (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + "\uAC1C \uB178\uB4DC";
          }
        },
        data: 9999
      });
  ...
  class NodesPerCountry {
    ...
    ngOnInit() {
      this.nodes$ = this.apiService.getNodeForCountry$(this.route.snapshot.params.country).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_11__.tap)(() => this.isLoading = true), (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.map)(response => {
        this.seoService.setTitle("" + response.country.en + "\uC758 \uB77C\uC774\uD2B8\uB2DD \uB178\uB4DC");
...
let NodesPerISPChartComponent = /*#__PURE__*/(() => {
  class NodesPerISPChartComponent {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("\uD1B5\uC2E0\uC0AC\uBCC4 \uB77C\uC774\uD2B8\uB2DD \uB178\uB4DC \uC218");
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${isp[1]} (${this.sortBy === 'capacity' ? isp[7] : isp[6]}%)</b><br>` + "" + nodeCount + "\uAC1C \uB178\uB4DC" + `<br>` + "" + this.amountShortenerPipe.transform(isp[2] / 100000000, 2) + " BTC";
            }
          },
          data: isp[0]
        });
      ...
      data.push({
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Other (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + "\uAC1C \uB178\uB4DC" + `<br>` + "" + this.amountShortenerPipe.transform(capacityOther / 100000000, 2) + " BTC";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "\uD558\uB098 \uC774\uC0C1\uC758 \uD074\uB9AC\uC5B4\uB137 IP \uC8FC\uC18C\uB97C \uACF5\uAC1C\uD55C \uB178\uB4DC\uC5D0\uC11C \uAD00\uB9AC\uD558\uB294 \uC720\uB3D9\uC131\uC758 \uD06C\uAE30";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "\uD1B5\uC2E0\uC0AC\uB97C \uC2DD\uBCC4\uD560 \uC218 \uC5C6\uB294 \uB178\uB4DC\uC5D0\uC11C \uAD00\uB9AC\uD558\uB294 \uC720\uB3D9\uC131\uC758 \uD06C\uAE30";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "Tor \uC8FC\uC18C\uB9CC \uACF5\uAC1C\uD55C \uB178\uB4DC\uC5D0\uC11C \uAD00\uB9AC\uD558\uB294 \uC720\uB3D9\uC131\uC758 \uD06C\uAE30";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "LN \uB178\uB4DC\uB97C \uD638\uC2A4\uD305\uD558\uB294 \uC0C1\uC704 100\uAC1C \uD1B5\uC2E0\uC0AC";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesPerISPPreview {
    ...
    ngOnInit() {
      this.nodes$ = this.route.paramMap.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_10__.switchMap)(params => {
        ...
        this.seoService.setTitle("\uD1B5\uC2E0\uC0AC \uAD00\uD560 \uB0B4 \uB77C\uC774\uD2B8\uB2DD \uB178\uB4DC: " + response.isp + " [AS" + this.route.snapshot.params.isp + "]");
...
let OldestNodes = /*#__PURE__*/(() => {
  class OldestNodes {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("\uAC00\uC7A5 \uC624\uB798\uB41C \uB77C\uC774\uD2B8\uB2DD \uB178\uB4DC");
...
let TopNodesPerCapacity = /*#__PURE__*/(() => {
  class TopNodesPerCapacity {
    ...
    ngOnInit() {
      ...
      if (!this.widget) {
        this.seoService.setTitle("\uC720\uB3D9\uC131 \uC21C\uC704");
...
let TopNodesPerChannels = /*#__PURE__*/(() => {
  class TopNodesPerChannels {
    ...
    ngOnInit() {
      ...
      if (this.widget === false) {
        this.seoService.setTitle("\uC5F0\uACB0\uC131 \uC21C\uC704");
...
let NodesRankingsDashboard = /*#__PURE__*/(() => {
  class NodesRankingsDashboard {
    ...
    ngOnInit() {
      this.seoService.setTitle("\uC0C1\uC704 \uB77C\uC774\uD2B8\uB2DD \uB178\uB4DC");
  ...
  class LightningStatisticsChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("\uB77C\uC774\uD2B8\uB2DD \uB124\uD2B8\uC6CC\uD06C \uC6A9\uB7C9");
