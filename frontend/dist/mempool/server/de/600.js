    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Dieser Kanal unterst\xFCtzt Routing ohne Basisgeb\xFChr";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "Dieser Kanal unterst\xFCtzt Routing nur mit Basisgeb\xFChr";
        }
        let i18n_9;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_9 = "Basisgeb\xFChr gr\xF6\xDFer als Null";
        }
        let i18n_10;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class ChannelPreviewComponent {
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.switchMap)(params => {
        ...
        this.seoService.setDescription("\xDCbersicht \xFCber den Lightning-Kanal " + params.get('short_id') + ". Zeige die Kanalkapazit\xE4t, die beteiligten Lightning-Knoten, zugeh\xF6rige On-Chain-Transaktionen und mehr an.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Fehler beim Laden der Daten.";
        }
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.switchMap)(params => {
        ...
        return this.lightningApiService.getChannel$(params.get('short_id')).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.tap)(value => {
          this.seoService.setTitle("Kanal: " + value.short_id + "");
          this.seoService.setDescription("\xDCbersicht \xFCber den Lightning-Kanal " + value.short_id + ". Zeige die Kanalkapazit\xE4t, die beteiligten Lightning-Knoten, zugeh\xF6rige On-Chain-Transaktionen und mehr an.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_11 = "Schlie\xDFende Transaktion";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class ClosingTypeComponent {
    ...
    getLabelFromType(type) {
      switch (type) {
        case 1:
          return {
            label: "Gegenseitig geschlossen",
            class: 'success'
          };
        case 2:
          return {
            label: "Zwangsgeschlossen",
            class: 'warning'
          };
        case 3:
          return {
            label: "Zwangsgeschlossen mit Strafzahlung",
            class: 'danger'
          };
        default:
          return {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Keine Kan\xE4le zum Anzeigen";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Die durchschnittliche Geb\xFChrenrate f\xFCr weiterleitende Nodes, ohne Geb\xFChrenrate >0.5% bzw. 5000ppm";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_3 = "Die durchschnittliche Basisgeb\xFChr, die von weiterleitenden Nodes verlangt wird, ohne solche >5000ppm";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_4 = "Durchschnittskapazit\xE4t";
        }
        let i18n_5;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Durchschnittsgeb\xFChrenrate";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "Durchschnitts-Basisgeb\xFChr";
        }
        let i18n_9;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Der Median der Geb\xFChrenrate, die von weiterleitenden Nodes verlangt wird, ohne solche >0,5% bzw. 5000ppm";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_11 = "Der Median der Basisgeb\xFChr, die von weiterleitenden Nodes verlangt wird, ohne solche >5000ppm";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_14 = "Median Geb\xFChrenrate";
        }
        let i18n_15;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_18 = "Durchschnittskapazit\xE4t";
        }
        let i18n_19;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_19 = "Durchschnittsgeb\xFChrenrate";
        }
        let i18n_20;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_20 = "Durchschnitts-Basisgeb\xFChr";
        }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_5 = "Durchschnittsgr\xF6\xDFe";
        }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "Schlie\xDFende Transaktion";
        }
...
let LightningDashboardComponent = /*#__PURE__*/(() => {
  class LightningDashboardComponent {
    ...
    ngOnInit() {
      this.onResize();
      this.seoService.setTitle("Lightning Explorer");
      this.seoService.setDescription("Erhalte Statistiken zum Lightning-Netzwerk (Gesamtkapazit\xE4t, Konnektivit\xE4t usw.), zu Lightning-Nodes (Kan\xE4le, Liquidit\xE4t usw.) und zu Lightning-Kan\xE4len (Status, Geb\xFChren usw.).");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Lightning Netzwerk Verlauf";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    prepareChartOptions(outgoingData, incomingData) {
      ...
      if (sum === 0) {
        title = {
          ...
          text: "Noch nichts da. Probier sp\xE4ter nochmal",
          left: 'center',
          top: 'center'
        };
      }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Prozentuale \xC4nderung letzte Woche";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Prozentuale \xC4nderung letzte Woche";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "Prozentuale \xC4nderung letzte Woche";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodePreviewComponent {
    ...
    ngOnInit() {
      this.node$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.switchMap)(params => {
        ...
        this.seoService.setDescription("\xDCbersicht \xFCber den Lightning-Netzwerkknoten mit dem Namen " + node.alias + ". Zeige Kan\xE4le, Kapazit\xE4t, Standort, Geb\xFChrenstatistiken und mehr an.");
        const socketsObject = [];
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Durchschnittsgr\xF6\xDFe";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "Fehler beim Laden der Daten.";
        }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Durchschnittliche Kanalgr\xF6\xDFe";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Durchschn. Kanalentfernung";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_11 = "Ausschlie\xDFlich auf Tor";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_25 = "LV Erweiterungs-Datens\xE4tze";
        }
        let i18n_26;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_28 = "Geschlossene Kan\xE4le";
        }
        let i18n_29;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesChannelsMap = /*#__PURE__*/(() => {
  class NodesChannelsMap {
    ...
    ngOnInit() {
      ...
      if (this.style === 'graph') {
        this.center = [0, 5];
        this.seoService.setTitle("Lightning Nodes Kan\xE4le Weltkarte");
        this.seoService.setDescription("Zeige die Kan\xE4le von Nicht-Tor-Lightning-Netzwerkknoten visualisiert auf einer Weltkarte an. Bewege den Mauszeiger/tippe auf Punkte auf der Karte, um Knotennamen und Details anzuzeigen.");
      }
      ...
      if (channels.length === 0) {
        if (!this.placeholder) {
          ...
          title = {
            ...
            text: "Keine Geolokationsdaten verf\xFCgbar",
            left: 'center',
            top: 'center'
          };
          this.zoom = 1.5;
        ...
        series: [{
          ...
          tooltip: {
            ...
            formatter: value => {
              ...
              ${liquidity}<br>` + "" + data[6] + " Kan\xE4le" + `<br>
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Weltkarte der Lightning-Node Kan\xE4le";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesMap = /*#__PURE__*/(() => {
  class NodesMap {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("Lightning Nodes Weltkarte");
        this.seoService.setDescription("Zeige die Standorte von Nicht-Tor-Lightning-Netzwerkknoten visualisiert auf einer Weltkarte an. Bewege den Mauszeiger/tippe auf Punkte auf der Karte, um Knotennamen und Details anzuzeigen.");
      }
      if (!this.inputNodes$) {
        ...
        series: [{
          ...
          tooltip: {
            ...
            formatter: value => {
              ...
              return `
                <b style="color: white">${alias}</b><br>
                ${liquidity}<br>` + "" + data[5] + " Kan\xE4le" + `<br>
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightning Nodes Weltkarte";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesNetworksChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("Lightning Nodes Pro Netzwerk");
        this.seoService.setDescription("Zeige die Anzahl der Lightning-Netzwerkknoten an, die im Laufe der Zeit nach Netzwerk visualisiert werden: nur Clearnet (IPv4, IPv6), Darknet (Tor, I2p, cjdns) und beide.");
    ...
    prepareChartOptions(data, maxYAxis) {
      ...
      if (!this.widget && data.tor_nodes.length === 0) {
        ...
        title = {
          ...
          text: "Lightning Nodes Pro Netzwerk",
          left: 'center',
          top: 0,
          zlevel: 10
        };
      ...
      const series = [{
        ...
        zlevel: 1,
        yAxisIndex: 0,
        name: "Nur Darknet (Tor, I2P, cjdns)",
        showSymbol: false,
        symbol: 'none',
        data: data.tor_nodes,
        type: 'line',
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightning Nodes Pro Netzwerk";
        }
...
let NodesPerCountryChartComponent = /*#__PURE__*/(() => {
  class NodesPerCountryChartComponent {
    ...
    ngOnInit() {
      this.seoService.setTitle("Lightning Nodes Pro Land");
      this.seoService.setDescription("Zeige eine geografische Aufschl\xFCsselung des Lightning-Netzwerks an: Wie viele Lightning-Knoten werden in L\xE4ndern auf der ganzen Welt gehostet, die gesamte BTC-Kapazit\xE4t f\xFCr jedes Land und mehr.");
    ...
    generateChartSerieData(country) {
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${country.name.en} (${country.share}%)</b><br>` + "" + nodeCount + " Nodes" + `<br>` + "" + this.amountShortenerPipe.transform(country.capacity / 100000000, 2) + " BTC Kapazit\xE4t";
            }
          },
          data: country.iso
        });
      ...
      data.push({
        ...
        name: "Sonstiges (" + (totalShareOther.toFixed(2) + '%') + ")",
        label: {
          overflow: 'truncate',
          color: 'var(--tooltip-grey)',
          alignTo: 'edge',
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Sonstiges (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + " Nodes";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightning Nodes Pro Land";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesPerCountry {
    ...
    ngOnInit() {
      this.nodes$ = this.apiService.getNodeForCountry$(this.route.snapshot.params.country).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_11__.tap)(() => this.isLoading = true), (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.map)(response => {
        this.seoService.setTitle("Lightning-Nodes in " + response.country.en + "");
        this.seoService.setDescription("Erkunde alle Lightning-Knoten, die in " + response.country.en + " gehostet werden, und sieh einen \xDCberblick \xFCber die Kapazit\xE4t jedes Knotens, die Anzahl der offenen Kan\xE4le und mehr an.");
        this.country = {
...
let NodesPerISPChartComponent = /*#__PURE__*/(() => {
  class NodesPerISPChartComponent {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("Lightning Nodes Pro ISP");
        this.seoService.setDescription("Durchsuche die Top 100 ISPs, die Lightning-Nodes hosten, zusammen mit Statistiken wie der Gesamtzahl der Knoten pro ISP, der gesamten BTC-Kapazit\xE4t pro ISP und mehr");
      }
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${isp[1]} (${this.sortBy === 'capacity' ? isp[7] : isp[6]}%)</b><br>` + "" + nodeCount + " Nodes" + `<br>` + "" + this.amountShortenerPipe.transform(isp[2] / 100000000, 2) + " BTC";
            }
          },
          data: isp[0]
        });
      ...
      data.push({
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Sonstiges (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + " Nodes" + `<br>` + "" + this.amountShortenerPipe.transform(capacityOther / 100000000, 2) + " BTC";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Wie viel Liquidit\xE4t auf Nodes liegt, die mindestens eine Clearnet IP Adresse verbreiten";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Wie viel Liquidit\xE4t auf Nodes liegt, deren ISP nicht feststellbar war";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "Wie viel Liquidit\xE4t liegt auf Nodes, die nur Tor Adressen verbreiten";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_4 = "Unbekannte Kapazit\xE4t";
        }
        let i18n_5;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Top 100 ISPs, die LN-Nodes beherbergen";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_14 = "Unbekannte Kapazit\xE4t";
        }
        let i18n_15;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesPerISPPreview {
    ...
    ngOnInit() {
      this.nodes$ = this.route.paramMap.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_10__.switchMap)(params => {
        ...
        this.seoService.setTitle("Lightning-Nodes auf ISP: " + response.isp + " [AS" + this.route.snapshot.params.isp + "]");
        this.seoService.setDescription("Durchsuche alle Bitcoin Lightning-Knoten, die den " + response.isp + " [AS " + this.route.snapshot.params.isp + "] ISP verwenden, und sieh aggregierte Statistiken wie die Gesamtzahl der Knoten, die Gesamtkapazit\xE4t und mehr f\xFCr den ISP.");
        for (const i in response.nodes) {
          response.nodes[i].geolocation = {
            country: response.nodes[i].country?.en,
            city: response.nodes[i].city?.en,
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Fehler beim Laden der Daten.";
        }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightning-Nodes auf ISP: " + "\uFFFD0\uFFFD" + "";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let OldestNodes = /*#__PURE__*/(() => {
  class OldestNodes {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("\xC4lteste Lightning Nodes");
        this.seoService.setDescription("Zeige die \xE4ltesten Knoten im Lightning-Netzwerk zusammen mit ihrer Kapazit\xE4t, Anzahl der Kan\xE4le, Standort usw.");
      }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Top 100 \xE4ltesten Lightning Nodes";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let TopNodesPerCapacity = /*#__PURE__*/(() => {
  class TopNodesPerCapacity {
    ...
    ngOnInit() {
      ...
      if (!this.widget) {
        this.seoService.setTitle("Liquidit\xE4ts Ranking");
        this.seoService.setDescription("Zeige die Lightning-Knoten mit der h\xF6chsten bereitgestellten BTC-Liquidit\xE4t sowie allgemeine Statistiken wie die Anzahl der offenen Kan\xE4le, Standort, Knotenalter und mehr.");
      }
...
let TopNodesPerChannels = /*#__PURE__*/(() => {
  class TopNodesPerChannels {
    ...
    ngOnInit() {
      ...
      if (this.widget === false) {
        this.seoService.setTitle("Verbindungs Rangliste");
        this.seoService.setDescription("Zeige die Lightning-Knoten mit den meisten offenen Kan\xE4len sowie allgemeine Statistiken wie die Gesamtknotenkapazit\xE4t, das Knotenalter und mehr.");
...
let NodesRankingsDashboard = /*#__PURE__*/(() => {
  class NodesRankingsDashboard {
    ...
    ngOnInit() {
      this.seoService.setTitle("Top Lightning Nodes");
      this.seoService.setDescription("Zeige die wichtigsten Lightning-Netzwerkknoten an, sortiert nach Liquidit\xE4t, Konnektivit\xE4t und Alter.");
  ...
  class LightningStatisticsChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("Lightning Netzwerk Kapazit\xE4t");
        this.seoService.setDescription("Zeige die Kapazit\xE4t des Lightning-Netzwerks im Zeitverlauf anhand der Anzahl offener Kan\xE4le und der gesamten Bitcoin-Kapazit\xE4t.");
        this.miningWindowPreference = this.miningService.getDefaultTimespan('all');
      }
      this.radioGroupForm = this.formBuilder.group({
        dateSpan: this.miningWindowPreference
    ...
    prepareChartOptions(data) {
      ...
      if (!this.widget && data.channel_count.length === 0) {
        ...
        title = {
          ...
          text: "Lightning Netzwerk Kapazit\xE4t",
          left: 'center',
          top: 0,
          zlevel: 10
        };
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightning Netzwerk Kapazit\xE4t";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
