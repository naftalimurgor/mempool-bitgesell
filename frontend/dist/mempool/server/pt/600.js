    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Este canal suporta roteamento com taxa base zero";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "Este canal n\xE3o suporta taxa base zero";
        }
        let i18n_9;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class ChannelPreviewComponent {
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.switchMap)(params => {
        ...
        this.seoService.setDescription("Vis\xE3o geral do canal Lightning " + params.get('short_id') + ". Veja a capacidade do canal, os n\xF3s do Lightning envolvidos, as transa\xE7\xF5es relacionadas on-chain e muito mais.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Erro ao carregar dados.";
        }
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.switchMap)(params => {
        ...
        return this.lightningApiService.getChannel$(params.get('short_id')).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.tap)(value => {
          this.seoService.setTitle("Canal: " + value.short_id + "");
          this.seoService.setDescription("Vis\xE3o geral do canal Lightning " + value.short_id + ". Veja a capacidade do canal, os n\xF3s do Lightning envolvidos, as transa\xE7\xF5es relacionadas on-chain e muito mais.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "\xDAltima atualiza\xE7\xE3o";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_9 = "Transa\xE7\xE3o de abertura";
        }
        let i18n_10;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_11 = "Transa\xE7\xE3o de fechamento";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class ClosingTypeComponent {
    ...
    getLabelFromType(type) {
      switch (type) {
        case 1:
          return {
            label: "Fechado mutuamente",
            class: 'success'
          };
        case 2:
          return {
            label: "For\xE7osamente fechado",
            class: 'warning'
          };
        case 3:
          return {
            label: "Fechado for\xE7osamente com penalidade",
            class: 'danger'
          };
        default:
          return {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Sem canais para mostrar";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Taxa m\xE9dia cobrada por n\xF3s de roteamento, ignorando taxas > 0.5% ou 5000ppm";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_3 = "Taxa m\xE9dia cobrada por n\xF3s de roteamento, ignorando taxas > 5000ppm";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Taxa mediana cobrada por n\xF3s de roteamento, ignorando taxas > 0.5% ou 5000ppm";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_11 = "Taxa mediana cobrada por n\xF3s de roteamento, ignorando taxas > 5000ppm";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Grupo de n\xF3s Lightning";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_7 = "Transa\xE7\xE3o de abertura";
        }
        let i18n_8;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_8 = "Transa\xE7\xE3o de fechamento";
        }
...
let LightningDashboardComponent = /*#__PURE__*/(() => {
  class LightningDashboardComponent {
    ...
    ngOnInit() {
      this.onResize();
      this.seoService.setTitle("Explorador Lightning");
      this.seoService.setDescription("Obtenha estat\xEDsticas sobre a rede Lightning (capacidade agregada, conectividade, etc.), n\xF3s Lightning (canais, liquidez, etc.) e canais Lightning (status, taxas, etc.).");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Estat\xEDsticas da Rede";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Estat\xEDsticas de Canais";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Hist\xF3rico da Rede Lightning";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_5 = "Classifica\xE7\xE3o por Liquidez";
        }
        let i18n_6;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_6 = "Classifica\xE7\xE3o por Conectividade";
        }
    ...
    prepareChartOptions(outgoingData, incomingData) {
      ...
      if (sum === 0) {
        title = {
          ...
          text: "Sem informa\xE7\xF5es para exibir. Tente novamente mais tarde.",
          left: 'center',
          top: 'center'
        };
      }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Distribui\xE7\xE3o de taxas";
        }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Mudan\xE7a percentual na \xFAltima semana";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Mudan\xE7a percentual na \xFAltima semana";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "Mudan\xE7a percentual na \xFAltima semana";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodePreviewComponent {
    ...
    ngOnInit() {
      this.node$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.switchMap)(params => {
        ...
        this.seoService.setDescription("Vis\xE3o geral do n\xF3 da rede Lightning denominado " + node.alias + ". Veja canais, capacidade, localiza\xE7\xE3o, estat\xEDsticas de taxas e muito mais.");
        const socketsObject = [];
  ...
  class NodeComponent {
    ...
    ngOnInit() {
      this.node$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_22__.switchMap)(params => {
        ...
        this.seoService.setTitle("N\xF3: " + node.alias + "");
        this.seoService.setDescription("Vis\xE3o geral do n\xF3 da rede Lightning denominado " + node.alias + ". Veja canais, capacidade, localiza\xE7\xE3o, estat\xEDsticas de taxas e muito mais.");
        this.clearnetSocketCount = 0;
        this.torSocketCount = 0;
        const socketsObject = [];
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Tamanho m\xE9dio de canal";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_5 = "Vista pela primeira vez";
        }
        let i18n_6;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Dist\xE2ncia m\xE9dia entre canais";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_17 = "An\xFAncio de liquidez";
        }
        let i18n_18;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_23 = "Loca\xE7\xE3o compacta";
        }
        let i18n_24;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_25 = "Registros de extens\xE3o de valor alocado total";
        }
        let i18n_26;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesChannelsMap = /*#__PURE__*/(() => {
  class NodesChannelsMap {
    ...
    ngOnInit() {
      ...
      if (this.style === 'graph') {
        this.center = [0, 5];
        this.seoService.setTitle("Mapa Mundial de Canais Lightning");
        this.seoService.setDescription("Veja os canais de n\xF3s da rede n\xE3o-Tor Lightning visualizados em um mapa mundial. Passe o mouse/toque nos pontos do mapa para obter nomes e detalhes dos n\xF3s.");
      }
      ...
      if (channels.length === 0) {
        if (!this.placeholder) {
          ...
          title = {
            ...
            text: "Informa\xE7\xE3o de geolocaliza\xE7\xE3o n\xE3o dispon\xEDvel",
            left: 'center',
            top: 'center'
          };
          this.zoom = 1.5;
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Mapa Mundial de Canais de N\xF3s Lightning";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "(N\xF3s da rede Tor exclu\xEDdos)";
        }
...
let NodesMap = /*#__PURE__*/(() => {
  class NodesMap {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("Mapa Mundial de N\xF3s Lightning");
        this.seoService.setDescription("Veja as localiza\xE7\xF5es dos n\xF3s da rede n\xE3o-Tor Lightning visualizados em um mapa mundial. Passe o mouse/toque nos pontos do mapa para obter nomes e detalhes dos n\xF3s.");
      }
      if (!this.inputNodes$) {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Mapa Mundial de N\xF3s Lightning";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesNetworksChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("N\xF3s Lightning por Rede");
        this.seoService.setDescription("Veja o n\xFAmero de n\xF3s da rede Lightning visualizados ao longo do tempo por rede: somente clearnet (IPv4, IPv6), darknet (Tor, I2p, cjdns) e ambos.");
    ...
    prepareChartOptions(data, maxYAxis) {
      ...
      if (!this.widget && data.tor_nodes.length === 0) {
        title = {
          ...
          text: "Indexa\xE7\xE3o em progresso",
          left: 'center',
          top: 'center'
        };
        ...
        title = {
          ...
          text: "N\xF3s Lightning por Rede",
          left: 'center',
          top: 0,
          zlevel: 10
        };
      ...
      const series = [{
        ...
        zlevel: 1,
        yAxisIndex: 0,
        name: "Somente Clearnet (IPv4, IPv6)",
        showSymbol: false,
        symbol: 'none',
        ...
        zlevel: 1,
        yAxisIndex: 0,
        name: "Somente Darknet (Tor, I2P, cjdns)",
        showSymbol: false,
        symbol: 'none',
        data: data.tor_nodes,
        type: 'line',
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "N\xF3s Lightning por Rede";
        }
...
let NodesPerCountryChartComponent = /*#__PURE__*/(() => {
  class NodesPerCountryChartComponent {
    ...
    ngOnInit() {
      this.seoService.setTitle("N\xF3s Lightning por Pa\xEDs");
      this.seoService.setDescription("Veja um detalhamento geogr\xE1fico da rede Lightning: quantos n\xF3s Lightning est\xE3o hospedados em pa\xEDses ao redor do mundo, capacidade agregada de BTC para cada pa\xEDs e muito mais.");
    ...
    generateChartSerieData(country) {
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${country.name.en} (${country.share}%)</b><br>` + "" + nodeCount + " n\xF3s" + `<br>` + "Capacidade de " + this.amountShortenerPipe.transform(country.capacity / 100000000, 2) + " BTC";
            }
          },
          data: country.iso
        });
      ...
      data.push({
        ...
        name: "Outros (" + (totalShareOther.toFixed(2) + '%') + ")",
        label: {
          overflow: 'truncate',
          color: 'var(--tooltip-grey)',
          alignTo: 'edge',
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Outros (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + " n\xF3s";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "N\xF3s Lightning por Pa\xEDs";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesPerCountry {
    ...
    ngOnInit() {
      this.nodes$ = this.apiService.getNodeForCountry$(this.route.snapshot.params.country).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_11__.tap)(() => this.isLoading = true), (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.map)(response => {
        this.seoService.setTitle("N\xF3s lightning no(a) " + response.country.en + "");
        this.seoService.setDescription("Explore todos os n\xF3s do Lightning hospedados em " + response.country.en + " e tenha uma vis\xE3o geral da capacidade de cada n\xF3, n\xFAmero de canais abertos e muito mais.");
        this.country = {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "N\xF3s lightning no(a) " + "\uFFFD0\uFFFD" + "";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Vista pela primeira vez";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_3 = "\xDAltima atualiza\xE7\xE3o";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "N\xFAmero de Provedores";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesPerISPChartComponent = /*#__PURE__*/(() => {
  class NodesPerISPChartComponent {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("N\xF3s Lightning por Provedora");
        this.seoService.setDescription("Navegue pelos 100 principais provedores que hospedam n\xF3s Lightning junto com estat\xEDsticas como n\xFAmero total de n\xF3s por provedor, capacidade agregada de BTC por provedor e muito mais");
      }
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${isp[1]} (${this.sortBy === 'capacity' ? isp[7] : isp[6]}%)</b><br>` + "" + nodeCount + " n\xF3s" + `<br>` + "" + this.amountShortenerPipe.transform(isp[2] / 100000000, 2) + " BTC";
            }
          },
          data: isp[0]
        });
      ...
      data.push({
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Outros (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + " n\xF3s" + `<br>` + "" + this.amountShortenerPipe.transform(capacityOther / 100000000, 2) + " BTC";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Quanta liquidez existe em n\xF3s anunciando ao menos um endere\xE7o IP na Clearnet";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Quanta liquidez existe em n\xF3s cujo provedor n\xE3o foi identificado";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "Quanta liquidez existe em n\xF3s anunciando apenas endere\xE7os Tor";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Top 100 provedores hospendando n\xF3s lightning";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_7 = "(N\xF3s da rede Tor exclu\xEDdos)";
        }
        let i18n_8;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_16 = "Indexa\xE7\xE3o em andamento";
        }
  ...
  class NodesPerISPPreview {
    ...
    ngOnInit() {
      this.nodes$ = this.route.paramMap.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_10__.switchMap)(params => {
        ...
        this.seoService.setTitle("N\xF3s lightning no Provedor: " + response.isp + " [AS" + this.route.snapshot.params.isp + "]");
        this.seoService.setDescription("Navegue por todos os n\xF3s Bitcoin Lightning usando o provedor " + response.isp + " [AS" + this.route.snapshot.params.isp + "] e veja estat\xEDsticas agregadas, como n\xFAmero total de n\xF3s, capacidade total, e muito mais para o provedor.");
        for (const i in response.nodes) {
          response.nodes[i].geolocation = {
            country: response.nodes[i].country?.en,
            city: response.nodes[i].city?.en,
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "N\xF3s lightning no Provedor: " + "\uFFFD0\uFFFD" + "";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let OldestNodes = /*#__PURE__*/(() => {
  class OldestNodes {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("N\xF3s lightning mais antigos");
        this.seoService.setDescription("Veja os n\xF3s mais antigos da rede Lightning junto com sua capacidade, n\xFAmero de canais, localiza\xE7\xE3o, etc.");
      }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_1 = "Vista pela primeira vez";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "100 n\xF3s lightning mais antigos";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_5 = "\xDAltima atualiza\xE7\xE3o";
        }
        let i18n_6;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let TopNodesPerCapacity = /*#__PURE__*/(() => {
  class TopNodesPerCapacity {
    ...
    ngOnInit() {
      ...
      if (!this.widget) {
        this.seoService.setTitle("Classifica\xE7\xE3o por Liquidez");
        this.seoService.setDescription("Veja os n\xF3s do Lightning com a maior liquidez BTC implantada, juntamente com estat\xEDsticas de alto n\xEDvel, como n\xFAmero de canais abertos, localiza\xE7\xE3o, idade do n\xF3 e muito mais.");
      }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Classifica\xE7\xE3o por Liquidez";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_4 = "Vista pela primeira vez";
        }
        let i18n_5;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let TopNodesPerChannels = /*#__PURE__*/(() => {
  class TopNodesPerChannels {
    ...
    ngOnInit() {
      ...
      if (this.widget === false) {
        this.seoService.setTitle("Classifica\xE7\xE3o por Conectividade");
        this.seoService.setDescription("Veja os n\xF3s do Lightning com o maior n\xFAmero de canais abertos, juntamente com estat\xEDsticas de alto n\xEDvel, como capacidade total do n\xF3, idade do n\xF3 e muito mais.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Classifica\xE7\xE3o por Conectividade";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesRankingsDashboard = /*#__PURE__*/(() => {
  class NodesRankingsDashboard {
    ...
    ngOnInit() {
      this.seoService.setTitle("Principais n\xF3s Lightning");
      this.seoService.setDescription("Veja os principais n\xF3s da rede Lightning classificados por liquidez, conectividade e idade.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Classifica\xE7\xE3o por Liquidez";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Classifica\xE7\xE3o por Conectividade";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class LightningStatisticsChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("Capacidade da Rede Lightning");
        this.seoService.setDescription("Veja a capacidade da rede Lightning visualizada ao longo do tempo em termos de n\xFAmero de canais abertos e capacidade total de bitcoin.");
        this.miningWindowPreference = this.miningService.getDefaultTimespan('all');
      }
      this.radioGroupForm = this.formBuilder.group({
        dateSpan: this.miningWindowPreference
    ...
    prepareChartOptions(data) {
      ...
      if (!this.widget && data.channel_count.length === 0) {
        ...
        title = {
          ...
          text: "Capacidade da Rede Lightning",
          left: 'center',
          top: 0,
          zlevel: 10
        };
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Capacidade da Rede Lightning";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Indexa\xE7\xE3o em andamento";
        }
