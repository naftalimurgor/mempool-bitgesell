    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "" + "\uFFFD#2\uFFFD" + "mempool.space apenas fornece dados sobre a rede Bitcoin." + "\uFFFD/#2\uFFFD" + " Ele n\xE3o pode ajud\xE1-lo a recuperar fundos, problemas de carteira etc." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "Para qualquer solicita\xE7\xE3o desse tipo, voc\xEA precisa entrar em contato com a entidade que ajudou a fazer a transa\xE7\xE3o (software de carteira, corretora, etc.)." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "";
        }
...
let DocsComponent = /*#__PURE__*/(() => {
  class DocsComponent {
    ...
    ngDoCheck() {
      ...
      if (url[0].path === "faq") {
        this.activeTab = 0;
        this.seoService.setTitle("Perguntas frequentes");
        this.seoService.setDescription("Obtenha respostas para perguntas comuns como: O que \xE9 um mempool? Por que minha transa\xE7\xE3o n\xE3o est\xE1 sendo confirmada? Como posso executar minha pr\xF3pria inst\xE2ncia do The Mempool Open Source Project? E mais.");
        this.ogService.setManualOgImage('faq.jpg');
      } else if (url[1].path === "rest") {
        this.activeTab = 1;
        this.seoService.setTitle("API REST");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Documenta\xE7\xE3o para o servi\xE7o API REST liquid.network: obtenha informa\xE7\xF5es sobre endere\xE7os, transa\xE7\xF5es, ativos, blocos e muito mais.");
        } else {
          this.seoService.setDescription("Documenta\xE7\xE3o para o servi\xE7o REST API mempool.space: obtenha informa\xE7\xF5es sobre endere\xE7os, transa\xE7\xF5es, blocos, taxas, minera\xE7\xE3o, rede Lightning e muito mais.");
        }
      } else if (url[1].path === "websocket") {
        this.activeTab = 2;
        this.seoService.setTitle("API WebSocket");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Documenta\xE7\xE3o para o servi\xE7o API WebSocket liquid.network: obtenha informa\xE7\xF5es em tempo real sobre blocos, mempools, transa\xE7\xF5es, endere\xE7os e muito mais.");
        } else {
          this.seoService.setDescription("Documenta\xE7\xE3o para o servi\xE7o API WebSocket mempool.space: obtenha informa\xE7\xF5es em tempo real sobre blocos, mempools, transa\xE7\xF5es, endere\xE7os e muito mais.");
        }
      } else {
        this.activeTab = 3;
        this.seoService.setTitle("Electrum RPC");
        this.seoService.setDescription("Documenta\xE7\xE3o para nossa interface Electrum RPC: obtenha acesso instant\xE2neo, conveniente e confi\xE1vel a uma inst\xE2ncia Esplora.");
      }
    }
    ngOnDestroy() {
