    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_1 = "Z\xE1kladn\xED poplatek";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_4 = "Delta \u010Dasov\xE9ho z\xE1mku";
        }
        let i18n_5;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Tento kan\xE1l podporuje sm\u011Brov\xE1n\xED s nulov\xFDm z\xE1kladn\xEDm poplatkem";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_7 = "Nulov\xFD z\xE1kladn\xED poplatek";
        }
        let i18n_8;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_8 = "Tento kan\xE1l nepodporuje sm\u011Brov\xE1n\xED s nulov\xFDm z\xE1kladn\xEDm poplatkem.";
        }
        let i18n_9;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_9 = "Nenulov\xFD z\xE1kladn\xED poplatek";
        }
        let i18n_10;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Po\u010D\xE1te\u010Dn\xED z\u016Fstatek";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class ChannelPreviewComponent {
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.switchMap)(params => {
        ...
        this.seoService.setDescription("P\u0159ehled Lightning kan\xE1lu " + params.get('short_id') + ". Pod\xEDvejte se na kapacitu kan\xE1lu, zapojen\xE9 Lightning uzly, souvisej\xEDc\xED transakce v on-chainu a dal\u0161\xED.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Z\xE1kladn\xED poplatek";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Chyba p\u0159i na\u010D\xEDt\xE1n\xED dat.";
        }
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.switchMap)(params => {
        ...
        return this.lightningApiService.getChannel$(params.get('short_id')).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.tap)(value => {
          this.seoService.setTitle("Kan\xE1l: " + value.short_id + "");
          this.seoService.setDescription("P\u0159ehled Lightning kan\xE1lu " + value.short_id + ". Pod\xEDvejte se na kapacitu kan\xE1lu, zapojen\xE9 Lightning uzly, souvisej\xEDc\xED transakce v on-chainu a dal\u0161\xED.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Posledn\xED aktualizace";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_9 = "Otv\xEDrac\xED transakce";
        }
        let i18n_10;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_11 = "Uzav\xEDrac\xED transakce";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class ClosingTypeComponent {
    ...
    getLabelFromType(type) {
      switch (type) {
        case 1:
          return {
            label: "Vz\xE1jemn\u011B uzav\u0159eno",
            class: 'success'
          };
        case 2:
          return {
            label: "Uzav\u0159eno vynucen\u011B",
            class: 'warning'
          };
        case 3:
          return {
            label: "Uzav\u0159eno vynucen\u011B s pokutou",
            class: 'danger'
          };
        default:
          return {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "\u017D\xE1dn\xE9 kan\xE1ly k zobrazen\xED";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Pr\u016Fm\u011Brn\xE1 sazba poplatk\u016F \xFA\u010Dtovan\xE1 sm\u011Brovac\xEDmi uzly, p\u0159i\u010Dem\u017E se ignoruj\xED sazby poplatk\u016F > 0,5% nebo 5000 ppm.";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_3 = "Pr\u016Fm\u011Brn\xFD z\xE1kladn\xED poplatek \xFA\u010Dtovan\xFD sm\u011Brovac\xEDmi uzly, bez ohledu na z\xE1kladn\xED poplatky > 5000ppm.";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "Pr\u016Fm. z\xE1kladn\xED poplatek";
        }
        let i18n_9;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Medi\xE1nov\xE1 sazba poplatk\u016F \xFA\u010Dtovan\xE1 sm\u011Brovac\xEDmi uzly, p\u0159i\u010Dem\u017E se neberou v \xFAvahu sazby poplatk\u016F > 0,5% nebo 5000 ppm.";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_11 = "Medi\xE1n z\xE1kladn\xEDch poplatk\u016F \xFA\u010Dtovan\xFDch sm\u011Brovac\xEDmi uzly, p\u0159i\u010Dem\u017E se neberou v \xFAvahu z\xE1kladn\xED poplatky > 5000ppm.";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_12 = "Medi\xE1nov\xE1 kapacita";
        }
        let i18n_13;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_14 = "Medi\xE1nov\xFD poplatek";
        }
        let i18n_15;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_16 = "Medi\xE1nov\xFD z\xE1kladn\xED poplatek";
        }
        let i18n_17;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_20 = "Pr\u016Fm. z\xE1kladn\xED poplatek";
        }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_7 = "Otv\xEDrac\xED transakce";
        }
        let i18n_8;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_8 = "Uzav\xEDrac\xED transakce";
        }
...
let LightningDashboardComponent = /*#__PURE__*/(() => {
  class LightningDashboardComponent {
    ...
    ngOnInit() {
      this.onResize();
      this.seoService.setTitle("Lightning pr\u016Fzkumn\xEDk");
      this.seoService.setDescription("Z\xEDskejte statistiky s\xEDt\u011B Lightning (souhrnnou kapacitu, konektivitu atd.), uzly Lightning (kan\xE1ly, likvidita atd.) a kan\xE1ly Lightning (stav, poplatky atd.).");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "S\xED\u0165ov\xE9 statistiky";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Historie Lightning s\xEDt\u011B";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "\u017Deb\u0159\xED\u010Dek konektivity";
        }
    ...
    prepareChartOptions(outgoingData, incomingData) {
      ...
      if (sum === 0) {
        title = {
          ...
          text: "Zat\xEDm se nezobrazuj\xED \u017E\xE1dn\xE1 data. Zkuste to pozd\u011Bji.",
          left: 'center',
          top: 'center'
        };
      }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Procentu\xE1ln\xED zm\u011Bna za posledn\xED t\xFDden";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Procentu\xE1ln\xED zm\u011Bna za posledn\xED t\xFDden";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "Procentu\xE1ln\xED zm\u011Bna za posledn\xED t\xFDden";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodePreviewComponent {
    ...
    ngOnInit() {
      this.node$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.switchMap)(params => {
        ...
        this.seoService.setDescription("P\u0159ehled pro Lightning uzel s n\xE1zvem " + node.alias + ". Pod\xEDvejte se na kan\xE1ly, kapacitu, um\xEDst\u011Bn\xED, statistiky poplatk\u016F a dal\u0161\xED informace.");
        const socketsObject = [];
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "Chyba p\u0159i na\u010D\xEDt\xE1n\xED dat.";
        }
  ...
  class NodeComponent {
    ...
    ngOnInit() {
      this.node$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_22__.switchMap)(params => {
        ...
        this.seoService.setTitle("Uzel: " + node.alias + "");
        this.seoService.setDescription("P\u0159ehled pro Lightning uzel s n\xE1zvem " + node.alias + ". Pod\xEDvejte se na kan\xE1ly, kapacitu, um\xEDst\u011Bn\xED, statistiky poplatk\u016F a dal\u0161\xED informace.");
        this.clearnetSocketCount = 0;
        this.torSocketCount = 0;
        const socketsObject = [];
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Pr\u016Fm\u011Brn\xE1 velikost kan\xE1lu";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Pr\u016Fm\u011Brn\xE1 vzd\xE1lenost kan\xE1l\u016F";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_17 = "Inzer\xE1t na likviditu";
        }
        let i18n_18;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_18 = "Sazba poplatku za pron\xE1jem";
        }
        let i18n_19;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_19 = "Z\xE1kladn\xED poplatek za pron\xE1jem";
        }
        let i18n_20;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_20 = "V\xE1ha financov\xE1n\xED";
        }
        let i18n_21;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_21 = "Sazba poplatku za kan\xE1l";
        }
        let i18n_22;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_22 = "Z\xE1kladn\xED poplatek za kan\xE1l";
        }
        let i18n_23;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_23 = "Kompaktn\xED pron\xE1jem";
        }
        let i18n_24;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_25 = "Z\xE1znamy o roz\u0161\xED\u0159en\xED TLV";
        }
        let i18n_26;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesChannelsMap = /*#__PURE__*/(() => {
  class NodesChannelsMap {
    ...
    ngOnInit() {
      ...
      if (this.style === 'graph') {
        this.center = [0, 5];
        this.seoService.setTitle("Sv\u011Btov\xE1 mapa kan\xE1l\u016F Lightning uzl\u016F");
        this.seoService.setDescription("Prohl\xE9dn\u011Bte si kan\xE1ly jin\xFDch ne\u017E Tor Lightning uzl\u016F vizualizovan\xE9 na map\u011B sv\u011Bta. N\xE1zvy uzl\u016F a podrobnosti zobraz\xEDte um\xEDst\u011Bn\xEDm kurzoru nebo klepnut\xEDm na body na map\u011B.");
      }
      ...
      if (channels.length === 0) {
        if (!this.placeholder) {
          ...
          title = {
            ...
            text: "Nejsou k dispozici \u017E\xE1dn\xE9 geoloka\u010Dn\xED \xFAdaje",
            left: 'center',
            top: 'center'
          };
          this.zoom = 1.5;
        ...
        series: [{
          ...
          tooltip: {
            ...
            formatter: value => {
              ...
              ${liquidity}<br>` + "" + data[6] + " kan\xE1l\u016F" + `<br>
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Sv\u011Btov\xE1 mapa kan\xE1l\u016F Lightning uzl\u016F";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Mapa aktivn\xEDch kan\xE1l\u016F";
        }
...
let NodesMap = /*#__PURE__*/(() => {
  class NodesMap {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("Sv\u011Btov\xE1 mapa Lightning uzl\u016F");
        this.seoService.setDescription("Pod\xEDvejte se na um\xEDst\u011Bn\xED jin\xFDch ne\u017E Tor Lightning uzl\u016F s\xEDt\u011B vizualizovan\xFDch na map\u011B sv\u011Bta. N\xE1zvy uzl\u016F a podrobnosti zobraz\xEDte um\xEDst\u011Bn\xEDm kurzoru nebo klepnut\xEDm na body na map\u011B.");
      }
      if (!this.inputNodes$) {
        ...
        series: [{
          ...
          tooltip: {
            ...
            formatter: value => {
              ...
              return `
                <b style="color: white">${alias}</b><br>
                ${liquidity}<br>` + "" + data[5] + " kan\xE1l\u016F" + `<br>
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Sv\u011Btov\xE1 mapa Lightning uzl\u016F";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesNetworksChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("Lightning uzly v s\xEDti");
        this.seoService.setDescription("Pod\xEDvejte se na po\u010Det uzl\u016F Lightning s\xEDt\u011B vizualizovan\xFDch v pr\u016Fb\u011Bhu \u010Dasu podle s\xEDt\u011B: pouze clearnet (IPv4, IPv6), darknet (Tor, I2p, cjdns) a oboj\xED.");
    ...
    prepareChartOptions(data, maxYAxis) {
      ...
      if (!this.widget && data.tor_nodes.length === 0) {
        title = {
          ...
          text: "Prob\xEDhaj\xEDc\xED indexace",
          left: 'center',
          top: 'center'
        };
      ...
      const series = [{
        ...
        zlevel: 1,
        yAxisIndex: 0,
        name: "Pouze Darknet (Tor, I2P, cjdns)",
        showSymbol: false,
        symbol: 'none',
        data: data.tor_nodes,
        type: 'line',
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightning uzly v s\xEDti";
        }
...
let NodesPerCountryChartComponent = /*#__PURE__*/(() => {
  class NodesPerCountryChartComponent {
    ...
    ngOnInit() {
      this.seoService.setTitle("Lightning uzly podle zem\xED");
      this.seoService.setDescription("Pod\xEDvejte se na geografick\xE9 rozd\u011Blen\xED Lightning s\xEDt\u011B: kolik uzl\u016F Lightning je hostov\xE1no v zem\xEDch po cel\xE9m sv\u011Bt\u011B, souhrnn\xE1 kapacita BTC pro ka\u017Edou zemi a dal\u0161\xED.");
    ...
    generateChartSerieData(country) {
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${country.name.en} (${country.share}%)</b><br>` + "" + nodeCount + " uzl\u016F" + `<br>` + "" + this.amountShortenerPipe.transform(country.capacity / 100000000, 2) + " BTC kapacita";
            }
          },
          data: country.iso
        });
      ...
      data.push({
        ...
        name: "Jin\xE9 (" + (totalShareOther.toFixed(2) + '%') + ")",
        label: {
          overflow: 'truncate',
          color: 'var(--tooltip-grey)',
          alignTo: 'edge',
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Jin\xE9 (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + " uzl\u016F";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightning uzly podle zem\xED";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesPerCountry {
    ...
    ngOnInit() {
      this.nodes$ = this.apiService.getNodeForCountry$(this.route.snapshot.params.country).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_11__.tap)(() => this.isLoading = true), (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.map)(response => {
        this.seoService.setTitle("Lightning uzly v " + response.country.en + "");
        this.seoService.setDescription("Prozkoumejte v\u0161echny Lightning uzly hostovan\xE9 v " + response.country.en + " a pod\xEDvejte se na p\u0159ehled kapacity ka\u017Ed\xE9ho uzlu, po\u010Dtu otev\u0159en\xFDch kan\xE1l\u016F a dal\u0161\xED.");
        this.country = {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Posledn\xED aktualizace";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesPerISPChartComponent = /*#__PURE__*/(() => {
  class NodesPerISPChartComponent {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("Lightning uzly na jednoho ISP");
        this.seoService.setDescription("Prohl\xE9dn\u011Bte si 100 nejlep\u0161\xEDch ISP hostuj\xEDc\xEDch Lightning uzly spolu se statistikami, jako je celkov\xFD po\u010Det uzl\u016F na ISP, agregovan\xE1 BTC kapacita na ISP a dal\u0161\xED");
      }
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${isp[1]} (${this.sortBy === 'capacity' ? isp[7] : isp[6]}%)</b><br>` + "" + nodeCount + " uzl\u016F" + `<br>` + "" + this.amountShortenerPipe.transform(isp[2] / 100000000, 2) + " BTC";
            }
          },
          data: isp[0]
        });
      ...
      data.push({
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Jin\xE9 (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + " uzl\u016F" + `<br>` + "" + this.amountShortenerPipe.transform(capacityOther / 100000000, 2) + " BTC";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Kolik likvidity b\u011B\u017E\xED na uzlech, kter\xE9 inzeruj\xED alespo\u0148 jednu IP adresu clearnetu.";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Kolik likvidity b\u011B\u017E\xED na uzlech, jejich\u017E ISP nebylo mo\u017En\xE9 identifikovat.";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "Kolik likvidity b\u011B\u017E\xED na uzlech inzeruj\xEDc\xEDch pouze Tor adresy";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "100 nejlep\u0161\xEDch ISP hostuj\xEDc\xEDch LN uzly";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_14 = "Nezn\xE1m\xE1 kapacita";
        }
        let i18n_15;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_16 = "Prob\xEDh\xE1 indexov\xE1n\xED";
        }
  ...
  class NodesPerISPPreview {
    ...
    ngOnInit() {
      this.nodes$ = this.route.paramMap.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_10__.switchMap)(params => {
        ...
        this.seoService.setTitle("Lightning uzly na ISP: " + response.isp + " [AS" + this.route.snapshot.params.isp + "]");
        this.seoService.setDescription("Proch\xE1zejte v\u0161echny uzly Bitcoin Lightning pomoc\xED " + response.isp + " [AS" + this.route.snapshot.params.isp + "] ISP a pod\xEDvejte se na souhrnn\xE9 statistiky, jako je celkov\xFD po\u010Det uzl\u016F, celkov\xE1 kapacita, a dal\u0161\xED pro ISP.");
        for (const i in response.nodes) {
          response.nodes[i].geolocation = {
            country: response.nodes[i].country?.en,
            city: response.nodes[i].city?.en,
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Chyba p\u0159i na\u010D\xEDt\xE1n\xED dat.";
        }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightning uzly na ISP: " + "\uFFFD0\uFFFD" + "";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let OldestNodes = /*#__PURE__*/(() => {
  class OldestNodes {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("Nejstar\u0161\xED lightningov\xE9 uzly");
        this.seoService.setDescription("Pod\xEDvejte se na nejstar\u0161\xED uzly v s\xEDti Lightning spolu s jejich kapacitou, po\u010Dtem kan\xE1l\u016F, um\xEDst\u011Bn\xEDm atd.");
      }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "100 nejstar\u0161\xEDch lightning uzl\u016F";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_5 = "Posledn\xED aktualizace";
        }
        let i18n_6;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let TopNodesPerCapacity = /*#__PURE__*/(() => {
  class TopNodesPerCapacity {
    ...
    ngOnInit() {
      ...
      if (!this.widget) {
        this.seoService.setTitle("\u017Deb\u0159\xED\u010Dek likvidity");
        this.seoService.setDescription("Prohl\xE9dn\u011Bte si Lightning uzly s nejv\u011Bt\u0161\xED likviditou BTC spolu se statistikami na vysok\xE9 \xFArovni, jako je po\u010Det otev\u0159en\xFDch kan\xE1l\u016F, um\xEDst\u011Bn\xED, st\xE1\u0159\xED uzlu a dal\u0161\xED.");
      }
...
let TopNodesPerChannels = /*#__PURE__*/(() => {
  class TopNodesPerChannels {
    ...
    ngOnInit() {
      ...
      if (this.widget === false) {
        this.seoService.setTitle("\u017Deb\u0159\xED\u010Dek konektivity");
        this.seoService.setDescription("Prohl\xE9dn\u011Bte si Lightning uzly s nejv\xEDce otev\u0159en\xFDmi kan\xE1ly spolu se statistikami na vysok\xE9 \xFArovni, jako je celkov\xE1 kapacita uzlu, st\xE1\u0159\xED uzlu a dal\u0161\xED.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "\u017Deb\u0159\xED\u010Dek konektivity";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesRankingsDashboard = /*#__PURE__*/(() => {
  class NodesRankingsDashboard {
    ...
    ngOnInit() {
      this.seoService.setTitle("Top lightning uzly");
      this.seoService.setDescription("Prohl\xE9dn\u011Bte si nejlep\u0161\xED uzly s\xEDt\u011B Lightning se\u0159azen\xE9 podle likvidity, konektivity a st\xE1\u0159\xED.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_1 = "\u017Deb\u0159\xED\u010Dek konektivity";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class LightningStatisticsChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("Kapacita Lightning s\xEDt\u011B");
        this.seoService.setDescription("Pod\xEDvejte se na vizualizaci kapacity s\xEDt\u011B Lightning v pr\u016Fb\u011Bhu \u010Dasu z hlediska po\u010Dtu otev\u0159en\xFDch kan\xE1l\u016F a celkov\xE9 kapacity bitcoin\u016F.");
        this.miningWindowPreference = this.miningService.getDefaultTimespan('all');
      }
      this.radioGroupForm = this.formBuilder.group({
        dateSpan: this.miningWindowPreference
    ...
    prepareChartOptions(data) {
      ...
      if (!this.widget && data.channel_count.length === 0) {
        ...
        title = {
          ...
          text: "Kapacita Lightning s\xEDt\u011B",
          left: 'center',
          top: 0,
          zlevel: 10
        };
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Kapacita Lightning s\xEDt\u011B";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Prob\xEDh\xE1 indexov\xE1n\xED";
        }
