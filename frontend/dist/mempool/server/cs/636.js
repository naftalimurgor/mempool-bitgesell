    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "" + "\uFFFD#2\uFFFD" + "mempool.space poskytuje pouze data o bitcoinov\xE9 s\xEDti." + "\uFFFD/#2\uFFFD" + " Nem\u016F\u017Ee v\xE1m pomoci s na\u010D\xEDt\xE1n\xEDm finan\u010Dn\xEDch prost\u0159edk\u016F, probl\xE9my s pen\u011B\u017Eenkou atd." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "V p\u0159\xEDpad\u011B jak\xFDchkoliv takov\xFDch \u017E\xE1dost\xED je t\u0159eba n\xE1s kontaktovat s entitou, kter\xE1 pomohla prov\xE9st transakci (software pen\u011B\u017Eenky, burzovn\xED spole\u010Dnost atd.)." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "";
        }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Nainstalujte bal\xED\u010Dek";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let DocsComponent = /*#__PURE__*/(() => {
  class DocsComponent {
    ...
    ngDoCheck() {
      ...
      if (url[0].path === "faq") {
        this.activeTab = 0;
        this.seoService.setTitle("\u010Cast\xE9 ot\xE1zky \xBB");
        this.seoService.setDescription("Z\xEDskejte odpov\u011Bdi na b\u011B\u017En\xE9 ot\xE1zky jako: Co je to mempool? Pro\u010D se moje transakce nepotvrzuje? Jak mohu spustit vlastn\xED instanci The Mempool Open Source Project? A v\xEDce.");
        this.ogService.setManualOgImage('faq.jpg');
      } else if (url[1].path === "rest") {
        this.activeTab = 1;
        this.seoService.setTitle("REST API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokumentace pro slu\u017Ebu liquid.network REST API: z\xEDskejte informace o adres\xE1ch, transakc\xEDch, aktivech, bloc\xEDch a dal\u0161\xEDch.");
        } else {
          this.seoService.setDescription("Dokumentace pro slu\u017Ebu mempool.space REST API: z\xEDskejte informace o adres\xE1ch, transakc\xEDch, bloc\xEDch, poplatc\xEDch, t\u011B\u017Eb\u011B, s\xEDti Lightning a dal\u0161\xEDch.");
        }
      } else if (url[1].path === "websocket") {
        this.activeTab = 2;
        this.seoService.setTitle("WebSocket API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokumentace pro slu\u017Ebu liquid.network WebSocket API: z\xEDskejte informace v re\xE1ln\xE9m \u010Dase o bloc\xEDch, mempoolech, transakc\xEDch, adres\xE1ch a dal\u0161\xEDch.");
        } else {
          this.seoService.setDescription("Dokumentace ke slu\u017Eb\u011B mempool.space WebSocket API: z\xEDskejte informace o bloc\xEDch, mempoolech, transakc\xEDch, adres\xE1ch a dal\u0161\xEDch v re\xE1ln\xE9m \u010Dase.");
        }
      } else {
        this.activeTab = 3;
        this.seoService.setTitle("Electrum RPC");
        this.seoService.setDescription("Dokumentace k na\u0161emu rozhran\xED Electrum RPC: z\xEDskejte okam\u017Eit\xFD, pohodln\xFD a spolehliv\xFD p\u0159\xEDstup k instanci Esplora.");
      }
    }
    ngOnDestroy() {
