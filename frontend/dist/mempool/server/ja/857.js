  ...
  class BlockComponent {
    ...
    ngOnInit() {
      ...
      this.block$ = this.route.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.switchMap)(params => {
        ...
        this.setNextAndPreviousBlockLink();
        this.seoService.setTitle("\u30D6\u30ED\u30C3\u30AF" + block.height + "\uFF1A" + block.id + "");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Liquid" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " \u30D6\u30ED\u30C3\u30AF " + block.height + " (" + block.id + ") \u306E\u30B5\u30A4\u30BA\u3001\u30A6\u30A7\u30A4\u30C8\u3001\u624B\u6570\u6599\u7BC4\u56F2\u3001\u542B\u307E\u308C\u308B\u30C8\u30E9\u30F3\u30B6\u30AF\u30B7\u30E7\u30F3\u306A\u3069\u3092\u78BA\u8A8D\u3057\u307E\u3059\u3002");
        } else {
          this.seoService.setDescription("\u30D3\u30C3\u30C8\u30B3\u30A4\u30F3" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " \u30D6\u30ED\u30C3\u30AF " + block.height + " (" + block.id + ") \u306E\u30B5\u30A4\u30BA\u3001\u30A6\u30A7\u30A4\u30C8\u3001\u624B\u6570\u6599\u7BC4\u56F2\u3001\u542B\u307E\u308C\u308B\u53D6\u5F15\u3001\u76E3\u67FB (\u4E88\u60F3\u3068\u5B9F\u969B) \u306A\u3069\u3092\u78BA\u8A8D\u3057\u307E\u3059\u3002");
        }
        this.isLoadingBlock = false;
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "\u3053\u306E\u30D6\u30ED\u30C3\u30AF\u306F\u30E1\u30A4\u30F3 \u30C1\u30A7\u30FC\u30F3\u306B\u5C5E\u3057\u3066\u304A\u3089\u305A\u3001\u6B21\u306E\u3082\u306E\u306B\u7F6E\u304D\u63DB\u3048\u3089\u308C\u3066\u3044\u307E\u3059\uFF1A";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_34 = "\u30D6\u30ED\u30C3\u30AF\u30C7\u30FC\u30BF\u3092\u8AAD\u307F\u8FBC\u307F\u4E2D\u306B\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F\u3002";
        }
        let i18n_35;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
