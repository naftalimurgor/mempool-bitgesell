    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "" + "\uFFFD#2\uFFFD" + "mempool.space tik pateikia duomenis apie Bitkoino tinkl\u0105." + "\uFFFD/#2\uFFFD" + " \u0160i paslauga negali pad\u0117ti prarast\u0173 l\u0117\u0161\u0173 atvejais, esant pinigin\u0117s klaidomis, ir pan. " + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + " D\u0117l toki\u0173 u\u017Eklaus\u0173, kreipkit\u0117s \u012F subjektus kurie pad\u0117jo jums sukonstruoti \u0161i\u0105 transakcij\u0105 (pinigin\u0117s k\u016Br\u0117jai, keitykla, ir pan.)." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "";
        }
  ...
  class DocsComponent {
    ...
    ngDoCheck() {
      ...
      if (url[0].path === "faq") {
        ...
        this.seoService.setDescription("Gaukite atsakymus \u012F bendrus klausimus kaip kad: Kas yra mempool? Kod\u0117l mano transakcija nepatvirtinta? Kaip \u012Fsidiegti savo The Mempool Open Source Project? Ir daugiau.");
        this.ogService.setManualOgImage('faq.jpg');
      } else if (url[1].path === "rest") {
        this.activeTab = 1;
        this.seoService.setTitle("REST API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokumentacija skirta liquid.network REST API paslaugai: gaukite info apie adresus, transakcijas, turt\u0105, blokus, ir daugiau.");
        } else {
          this.seoService.setDescription("Dokumentacija skirta mempool.space REST API paslaugai: gaukite info apie adresus, transakcijas, turt\u0105, blokus, ir daugiau.");
        }
      } else if (url[1].path === "websocket") {
        this.activeTab = 2;
        this.seoService.setTitle("WebSocket API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokumentacija skirta liquid.network WebSocket API paslaugai: gaukite info apie blokus, atminties telkinius, transakcijas, adresus, ir daugiau.");
        } else {
          this.seoService.setDescription("Dokumentacija skirta mempool.space WebSocket API paslaugai: gaukite info apie blokus, atminties telkinius, transakcijas, adresus, ir daugiau.");
        }
      } else {
        this.activeTab = 3;
