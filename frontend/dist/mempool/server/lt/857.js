    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "\u012Ekeliant duomenis \u012Fvyko klaida.";
        }
  ...
  class BlockComponent {
    ...
    ngOnInit() {
      ...
      this.block$ = this.route.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.switchMap)(params => {
        ...
        this.setNextAndPreviousBlockLink();
        this.seoService.setTitle("Blokas " + block.height + ": " + block.id + "");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("\u017Diur\u0117ti dyd\u012F, mokes\u010Di\u0173 ribas, \u012Ftrauktas transakcijas, ir daugiau Liquid" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " blokui " + block.height + " (" + block.id + ").");
        } else {
          this.seoService.setDescription("\u017Di\u016Br\u0117ti dyd\u012F, svor\u012F, mokes\u010Di\u0173 ribas, \u012Ftrauktas transakcijas, audit\u0105 (lauktas / esamas), ir daugiau Bitkoino" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " blokui " + block.height + " (" + block.id + "). ");
        }
        this.isLoadingBlock = false;
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "This block does not belong to the main chain, it has been replaced by:";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_34 = "Error loading block data.";
        }
        let i18n_35;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_35 = "Kod\u0117l \u0161is blokas tu\u0161\u010Dias?";
        }
        let i18n_36;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_39 = "Acceleration fees paid out-of-band";
        }
        let i18n_40;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
