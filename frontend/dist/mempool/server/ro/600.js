    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Acest canal accept\u0103 rutarea cu comision de baz\u0103 zero";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "Acest canal nu accept\u0103 rutarea cu comision de baz\u0103 zero";
        }
        let i18n_9;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_9 = "Comision de baz\u0103 diferit de zero";
        }
        let i18n_10;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class ChannelPreviewComponent {
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.switchMap)(params => {
        ...
        this.seoService.setDescription("Sumar pentru canalul Lightning " + params.get('short_id') + ". Vede\u021Bi capacitatea canalului, nodurile Lightning implicate, tranzac\u021Biile \xEEn-lan\u021B asociate \u0219i altele.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Eroare la \xEEnc\u0103rcarea datelor.";
        }
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.switchMap)(params => {
        ...
        return this.lightningApiService.getChannel$(params.get('short_id')).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.tap)(value => {
          ...
          this.seoService.setDescription("Sumar pentru canalul Lightning " + value.short_id + ". Vede\u021Bi capacitatea canalului, nodurile Lightning implicate, tranzac\u021Biile \xEEn-lan\u021B asociate \u0219i altele.");
  ...
  class ClosingTypeComponent {
    ...
    getLabelFromType(type) {
      switch (type) {
        case 1:
          return {
            label: "\xCEnchis reciproc",
            class: 'success'
          };
        case 2:
          return {
            label: "\xCEnchis for\u021Bat",
            class: 'warning'
          };
        case 3:
          return {
            label: "\xCEnchis for\u021Bat cu penalizare",
            class: 'danger'
          };
        default:
          return {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Nu exist\u0103 canale de afi\u0219at";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Comisionul mediu perceput de nodurile de rutare, ignor\xE2nd valori > 0,5% sau 5000 ppm";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_3 = "Comision de baz\u0103 mediu perceput de nodurile de rutare, ignor\xE2nd valori > 5000 ppm";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Rata median\u0103 a comisionului perceput de nodurile de rutare, ignor\xE2nd valori > 0,5% sau 5000 ppm";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_11 = "Comision de baz\u0103 median perceput de nodurile de rutare, ignor\xE2nd valori > 5000 ppm";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_16 = "Comision de baz\u0103 median";
        }
        let i18n_17;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_20 = "Comision de baz\u0103 mediu";
        }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Grup de noduri Lightning";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let LightningDashboardComponent = /*#__PURE__*/(() => {
  class LightningDashboardComponent {
    ...
    ngOnInit() {
      this.onResize();
      this.seoService.setTitle("Explorator Lightning");
      this.seoService.setDescription("Ob\u021Bine\u021Bi statistici despre re\u021Beaua Lightning (capacitate agregat\u0103, conectivitate etc.), nodurile Lightning (canale, lichiditate etc.) \u0219i canalele Lightning (stare, comisioane etc.).");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Istoric Re\u021Bea Lightning";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Clasament Conectivitate";
        }
    ...
    prepareChartOptions(outgoingData, incomingData) {
      ...
      if (sum === 0) {
        title = {
          ...
          text: "Nu exist\u0103 date de afi\u0219at \xEEnc\u0103. \xCEncerca\u021Bi mai t\xE2rziu.",
          left: 'center',
          top: 'center'
        };
      }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Modificare procentual\u0103 s\u0103pt\u0103m\xE2na trecut\u0103";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Modificare procentual\u0103 s\u0103pt\u0103m\xE2na trecut\u0103";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "Modificare procentual\u0103 s\u0103pt\u0103m\xE2na trecut\u0103";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodePreviewComponent {
    ...
    ngOnInit() {
      this.node$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.switchMap)(params => {
        ...
        this.seoService.setDescription("Sumar al nodului de re\u021Bea Lightning numit " + node.alias + ". Vede\u021Bi canalele, capacitatea, loca\u021Bia, statisticile comisioanelor \u0219i altele.");
        const socketsObject = [];
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "Eroare la \xEEnc\u0103rcarea datelor.";
        }
  ...
  class NodeComponent {
    ...
    ngOnInit() {
      this.node$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_22__.switchMap)(params => {
        ...
        this.seoService.setTitle("Nod: " + node.alias + "");
        this.seoService.setDescription("Sumar al nodului de re\u021Bea Lightning numit " + node.alias + ". Vede\u021Bi canalele, capacitatea, loca\u021Bia, statisticile comisioanelor \u0219i altele.");
        this.clearnetSocketCount = 0;
        this.torSocketCount = 0;
        const socketsObject = [];
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Dimensiunea medie a canalului";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Distan\u021Ba medie a canalului";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_18 = "Rata comisionului de \xEEnchiriere";
        }
        let i18n_19;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_19 = "Comisionul de inchiriere de baz\u0103";
        }
        let i18n_20;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_22 = "Comisionul de baz\u0103 al canalului";
        }
        let i18n_23;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_25 = "\xCEnregistr\u0103ri extensiil TLV";
        }
        let i18n_26;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesChannelsMap = /*#__PURE__*/(() => {
  class NodesChannelsMap {
    ...
    ngOnInit() {
      ...
      if (this.style === 'graph') {
        this.center = [0, 5];
        this.seoService.setTitle("Harta lumii cu canale ale nodurilor Lightning");
        this.seoService.setDescription("Vede\u021Bi canalele nodurilor de re\u021Bea non-Tor Lightning vizualizate pe o hart\u0103 a lumii. Trece\u021Bi cu mouse-ul/atinge\u021Bi punctele de pe hart\u0103 pentru numele \u0219i detaliile nodurilor.");
      }
      ...
      if (channels.length === 0) {
        if (!this.placeholder) {
          ...
          title = {
            ...
            text: "Nu sunt disponibile date de geolocalizare",
            left: 'center',
            top: 'center'
          };
          this.zoom = 1.5;
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Harta lumii cu canalele nodurilor Lightning";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesMap = /*#__PURE__*/(() => {
  class NodesMap {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("Harta lumii cu Noduri Lightning");
        this.seoService.setDescription("Vede\u021Bi loca\u021Biile nodurilor de re\u021Bea non-Tor Lightning vizualizate pe o hart\u0103 a lumii. Trece\u021Bi cu mouse-ul/atinge\u021Bi punctele de pe hart\u0103 pentru numele \u0219i detaliile nodurilor.");
      }
      if (!this.inputNodes$) {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Harta lumii cu Noduri Lightning";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesNetworksChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("Noduri Lightning Per Re\u021Bea");
        this.seoService.setDescription("Vede\u021Bi num\u0103rul de noduri de re\u021Bea Lightning vizualizate \xEEn timp \xEEn func\u021Bie de re\u021Bea: doar clearnet (IPv4, IPv6), darknet (Tor, I2p, cjdns) \u0219i ambele.");
    ...
    prepareChartOptions(data, maxYAxis) {
      ...
      if (!this.widget && data.tor_nodes.length === 0) {
        ...
        title = {
          ...
          text: "Noduri Lightning Per Re\u021Bea",
          left: 'center',
          top: 0,
          zlevel: 10
        };
      ...
      const series = [{
        ...
        zlevel: 1,
        yAxisIndex: 0,
        name: "Numai Darknet (Tor, I2P, cjdns)",
        showSymbol: false,
        symbol: 'none',
        data: data.tor_nodes,
        type: 'line',
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Noduri Lightning Per Re\u021Bea";
        }
...
let NodesPerCountryChartComponent = /*#__PURE__*/(() => {
  class NodesPerCountryChartComponent {
    ...
    ngOnInit() {
      this.seoService.setTitle("Noduri Lightning per \u021Bar\u0103");
      this.seoService.setDescription("Vede\u021Bi o defalcare geografic\u0103 a re\u021Belei Lightning: c\xE2te noduri Lightning sunt g\u0103zduite \xEEn \u021B\u0103ri din \xEEntreaga lume, capacitatea BTC agregat\u0103 pentru fiecare \u021Bar\u0103 \u0219i altele.");
    ...
    generateChartSerieData(country) {
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${country.name.en} (${country.share}%)</b><br>` + "" + nodeCount + " noduri" + `<br>` + "" + this.amountShortenerPipe.transform(country.capacity / 100000000, 2) + " capacitate BTC";
            }
          },
          data: country.iso
        });
      ...
      data.push({
        ...
        name: "Altele (" + (totalShareOther.toFixed(2) + '%') + ")",
        label: {
          overflow: 'truncate',
          color: 'var(--tooltip-grey)',
          alignTo: 'edge',
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Altele (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + " noduri";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Noduri Lightning per \u021Bar\u0103";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesPerCountry {
    ...
    ngOnInit() {
      this.nodes$ = this.apiService.getNodeForCountry$(this.route.snapshot.params.country).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_11__.tap)(() => this.isLoading = true), (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.map)(response => {
        this.seoService.setTitle("Noduri Lightning \xEEn " + response.country.en + "");
        this.seoService.setDescription("Explora\u021Bi toate nodurile Lightning g\u0103zduite \xEEn " + response.country.en + " \u0219i vede\u021Bi un sumar a capacit\u0103\u021Bii fiec\u0103rui nod, a num\u0103rului de canale deschise \u0219i altele.");
        this.country = {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Noduri Lightning \xEEn " + "\uFFFD0\uFFFD" + "";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesPerISPChartComponent = /*#__PURE__*/(() => {
  class NodesPerISPChartComponent {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("Noduri Lightning Per ISP");
        this.seoService.setDescription("R\u0103sfoi\u021Bi primii 100 de ISP-uri care g\u0103zduiesc noduri Lightning \xEEmpreun\u0103 cu statistici precum num\u0103rul total de noduri per ISP, capacitatea BTC agregat\u0103 per ISP \u0219i altele");
      }
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${isp[1]} (${this.sortBy === 'capacity' ? isp[7] : isp[6]}%)</b><br>` + "" + nodeCount + " noduri" + `<br>` + "" + this.amountShortenerPipe.transform(isp[2] / 100000000, 2) + " BTC";
            }
          },
          data: isp[0]
        });
      ...
      data.push({
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Altele (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + " noduri" + `<br>` + "" + this.amountShortenerPipe.transform(capacityOther / 100000000, 2) + " BTC";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "C\xE2t\u0103 lichiditate exist\u0103 pe nodurile care anun\u021B\u0103 cel pu\u021Bin o adres\u0103 IP din Clearnet";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "C\xE2t\u0103 lichiditate exist\u0103 pe noduri pe care ISP-ul nu a fost identificabil";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "C\xE2t\u0103 lichiditate exist\u0103 pe nodurile care anun\u021B\u0103 numai adrese Tor";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Top 100 ISP-uri care g\u0103zduiesc noduri LN";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesPerISPPreview {
    ...
    ngOnInit() {
      this.nodes$ = this.route.paramMap.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_10__.switchMap)(params => {
        ...
        this.seoService.setTitle("Noduri Lightning pe ISP: " + response.isp + " [CA" + this.route.snapshot.params.isp + "]");
        this.seoService.setDescription("R\u0103sfoi\u021Bi toate nodurile Bitcoin Lightning folosind " + response.isp + " [AS" + this.route.snapshot.params.isp + "] ISP \u0219i vede\u021Bi statistici agregate, cum ar fi num\u0103rul total de noduri, capacitatea total\u0103, \u0219i altele pentru ISP.");
        for (const i in response.nodes) {
          response.nodes[i].geolocation = {
            country: response.nodes[i].country?.en,
            city: response.nodes[i].city?.en,
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Eroare la \xEEnc\u0103rcarea datelor.";
        }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Noduri Lightning pe ISP: " + "\uFFFD0\uFFFD" + "";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let OldestNodes = /*#__PURE__*/(() => {
  class OldestNodes {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("Cele mai vechi noduri lightning");
        this.seoService.setDescription("Vede\u021Bi cele mai vechi noduri din re\u021Beaua Lightning \xEEmpreun\u0103 cu capacitatea lor, num\u0103rul de canale, loca\u021Bia etc.");
      }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Top 100 cele mai vechi noduri lightning";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let TopNodesPerCapacity = /*#__PURE__*/(() => {
  class TopNodesPerCapacity {
    ...
    ngOnInit() {
      ...
      if (!this.widget) {
        this.seoService.setTitle("Clasament Lichiditate");
        this.seoService.setDescription("Vede\u021Bi nodurile Lightning cu cea mai mare lichiditate BTC implementat\u0103 \xEEmpreun\u0103 cu statistici de nivel \xEEnalt, cum ar fi num\u0103rul de canale deschise, loca\u021Bia, v\xE2rsta nodului \u0219i altele.");
      }
...
let TopNodesPerChannels = /*#__PURE__*/(() => {
  class TopNodesPerChannels {
    ...
    ngOnInit() {
      ...
      if (this.widget === false) {
        this.seoService.setTitle("Clasament Conectivitate");
        this.seoService.setDescription("Vede\u021Bi nodurile Lightning cu cele mai multe canale deschise \xEEmpreun\u0103 cu statistici de nivel \xEEnalt, cum ar fi capacitatea total\u0103 a nodurilor, v\xE2rsta nodurilor \u0219i altele.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Clasament Conectivitate";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let NodesRankingsDashboard = /*#__PURE__*/(() => {
  class NodesRankingsDashboard {
    ...
    ngOnInit() {
      this.seoService.setTitle("Top noduri lightning");
      this.seoService.setDescription("Vede\u021Bi topul nodurilor de re\u021Bea Lightning clasate \xEEn func\u021Bie de lichiditate, conectivitate \u0219i vechime.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_1 = "Clasament Conectivitate";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class LightningStatisticsChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("Capacitatea re\u021Belei Lightning");
        this.seoService.setDescription("Vede\u021Bi capacitatea re\u021Belei Lightning vizualizat\u0103 \xEEn timp \xEEn ceea ce prive\u0219te num\u0103rul de canale deschise \u0219i capacitatea total\u0103 de bitcoin.");
        this.miningWindowPreference = this.miningService.getDefaultTimespan('all');
      }
      this.radioGroupForm = this.formBuilder.group({
        dateSpan: this.miningWindowPreference
    ...
    prepareChartOptions(data) {
      ...
      if (!this.widget && data.channel_count.length === 0) {
        ...
        title = {
          ...
          text: "Capacitatea re\u021Belei Lightning",
          left: 'center',
          top: 0,
          zlevel: 10
        };
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Capacitatea re\u021Belei Lightning";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
