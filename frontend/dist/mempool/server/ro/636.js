    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "" + "\uFFFD#2\uFFFD" + "mempool.space doar furnizeaz\u0103 date despre re\u021Beaua Bitcoin." + "\uFFFD/#2\uFFFD" + " Nu v\u0103 poate ajuta s\u0103 recupera\u021Bi fonduri, probleme cu portofelul etc." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "Pentru orice astfel de solicit\u0103ri, trebuie s\u0103 v\u0103 adresa\u021Bi entit\u0103\u021Bii care a ajutat la efectuarea tranzac\u021Biei (aplica\u021Bia de portofel, exchange etc.)." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "";
        }
...
let DocsComponent = /*#__PURE__*/(() => {
  class DocsComponent {
    ...
    ngDoCheck() {
      ...
      if (url[0].path === "faq") {
        this.activeTab = 0;
        this.seoService.setTitle("\xCEntreb\u0103ri frecvente");
        this.seoService.setDescription("Ob\u021Bine\u021Bi r\u0103spunsuri la \xEEntreb\u0103ri frecvente precum: Ce este un mempool? De ce nu se confirm\u0103 tranzac\u021Bia mea? Cum pot rula propria instan\u021B\u0103 a proiectului Open Source Mempool? \u0218i altele.");
        this.ogService.setManualOgImage('faq.jpg');
      } else if (url[1].path === "rest") {
        this.activeTab = 1;
        this.seoService.setTitle("REST API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Documenta\u021Bie pentru serviciul API REST liquid.network: ob\u021Bine\u021Bi informa\u021Bii despre adrese, tranzac\u021Bii, active, blocuri \u0219i altele.");
        } else {
          this.seoService.setDescription("Documenta\u021Bie pentru serviciul mempool.space REST API: ob\u021Bine\u021Bi informa\u021Bii despre adrese, tranzac\u021Bii, blocuri, comisioane, minerit, re\u021Beaua Lightning \u0219i altele.");
        }
      } else if (url[1].path === "websocket") {
        this.activeTab = 2;
        this.seoService.setTitle("WebSocket API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Documenta\u021Bie pentru serviciul liquid.network WebSocket API: ob\u021Bine\u021Bi informa\u021Bii \xEEn timp real despre blocuri, mempool-uri, tranzac\u021Bii, adrese \u0219i altele.");
        } else {
          this.seoService.setDescription("Documenta\u021Bie pentru serviciul mempool.space WebSocket API: ob\u021Bine\u021Bi informa\u021Bii \xEEn timp real despre blocuri, mempool-uri, tranzac\u021Bii, adrese \u0219i altele.");
        }
      } else {
        this.activeTab = 3;
        this.seoService.setTitle("Electrum RPC");
        this.seoService.setDescription("Documenta\u021Bie pentru interfa\u021Ba noastr\u0103 Electrum RPC: ob\u021Bine\u021Bi acces instantaneu, convenabil \u0219i de \xEEncredere la o instan\u021B\u0103 Esplora.");
      }
    }
    ngOnDestroy() {
