    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Den h\xE4r kanalen st\xF6der routing med noll basavgift";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "Den h\xE4r kanalen st\xF6der inte routing med noll i basavgift";
        }
        let i18n_9;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class ChannelPreviewComponent {
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.switchMap)(params => {
        ...
        this.seoService.setDescription("\xD6versikt f\xF6r Lightning-kanalen " + params.get('short_id') + ". Se kanalkapacitet, de inblandade Lightning-noderna, relaterade transaktioner i kedjan och mer.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Fel vid laddning av data.";
        }
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.switchMap)(params => {
        ...
        return this.lightningApiService.getChannel$(params.get('short_id')).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.tap)(value => {
          ...
          this.seoService.setDescription("\xD6versikt f\xF6r Lightning-kanalen " + value.short_id + ". Se kanalkapacitet, de inblandade Lightning-noderna, relaterade transaktioner i kedjan och mer.");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_11 = "St\xE4ngningstransaktion";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class ClosingTypeComponent {
    ...
    getLabelFromType(type) {
      switch (type) {
        case 1:
          return {
            label: "\xD6msesidigt st\xE4ngd",
            class: 'success'
          };
        case 2:
          return {
            label: "Tv\xE5ngsst\xE4ngd",
            class: 'warning'
          };
        case 3:
          return {
            label: "Tv\xE5ngsst\xE4ngd med straff",
            class: 'danger'
          };
        default:
          return {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Den genomsnittliga avgiftssatsen som tas ut av routingnoder, ignorerar avgiftssatser >0,5 % eller 5 000 ppm";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_3 = "Den genomsnittliga basavgiften som tas ut av routingnoder, ignorerar basavgifter > 5000 ppm";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "Medianavgiftssatsen som debiteras av routingnoder, ignorerar avgiftssatser >0,5% eller 5 000 ppm";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_11 = "Medianbasavgiften som tas ut av routingnoder, ignorerar basavgifter > 5000 ppm";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "St\xE4ngningstransaktion";
        }
...
let LightningDashboardComponent = /*#__PURE__*/(() => {
  class LightningDashboardComponent {
    ...
    ngOnInit() {
      this.onResize();
      this.seoService.setTitle("Lightningutforskare");
      this.seoService.setDescription("F\xE5 statistik om Lightning-n\xE4tverket (total kapacitet, anslutning, etc), Lightning-noder (kanaler, likviditet, etc) och Lightning-kanaler (status, avgifter, etc).");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "Lightningn\xE4tverkshistorik";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    prepareChartOptions(outgoingData, incomingData) {
      ...
      if (sum === 0) {
        title = {
          ...
          text: "Ingen data att visa \xE4nnu. F\xF6rs\xF6k igen senare.",
          left: 'center',
          top: 'center'
        };
      }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Procentuell f\xF6r\xE4ndring senaste veckan";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Procentuell f\xF6r\xE4ndring senaste veckan";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "Procentuell f\xF6r\xE4ndring senaste veckan";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodePreviewComponent {
    ...
    ngOnInit() {
      this.node$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.switchMap)(params => {
        ...
        this.seoService.setDescription("\xD6versikt f\xF6r Lightning-n\xE4tverksnoden " + node.alias + ". Se kanaler, kapacitet, plats, avgiftsstatistik och mer.");
        const socketsObject = [];
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_8 = "Fel vid laddning av data.";
        }
...
let NodesChannelsMap = /*#__PURE__*/(() => {
  class NodesChannelsMap {
    ...
    ngOnInit() {
      ...
      if (this.style === 'graph') {
        this.center = [0, 5];
        this.seoService.setTitle("V\xE4rldskarta \xF6ver Lightningkanaler");
        this.seoService.setDescription("Se kanalerna f\xF6r icke-Tor Lightning-n\xE4tverksnoder visualiserade p\xE5 en v\xE4rldskarta. H\xE5ll muspekaren/tryck p\xE5 punkter p\xE5 kartan f\xF6r nodnamn och detaljer.");
      }
      ...
      if (channels.length === 0) {
        if (!this.placeholder) {
          ...
          title = {
            ...
            text: "Ingen geolokaliseringsdata tillg\xE4nglig",
            left: 'center',
            top: 'center'
          };
          this.zoom = 1.5;
        ...
        series: [{
          ...
          tooltip: {
            ...
            formatter: value => {
              ...
              ${liquidity}<br>` + "" + data[6] + " kanaler" + `<br>
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "V\xE4rldskarta \xF6ver Lightning-noder och kanaler";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Karta \xF6ver aktiva kanaler";
        }
...
let NodesMap = /*#__PURE__*/(() => {
  class NodesMap {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("V\xE4rldskarta \xF6ver Lightningnoder");
        this.seoService.setDescription("Se platserna f\xF6r icke-Tor Lightning-n\xE4tverksnoder visualiserade p\xE5 en v\xE4rldskarta. H\xE5ll muspekaren/tryck p\xE5 punkter p\xE5 kartan f\xF6r nodnamn och detaljer.");
      }
      if (!this.inputNodes$) {
        ...
        series: [{
          ...
          tooltip: {
            ...
            formatter: value => {
              ...
              return `
                <b style="color: white">${alias}</b><br>
                ${liquidity}<br>` + "" + data[5] + " kanaler" + `<br>
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "V\xE4rldskarta \xF6ver Lightningnoder";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesNetworksChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("Lightningnoder per n\xE4tverk");
        this.seoService.setDescription("Se antalet Lightning-n\xE4tverksnoder som visualiserats \xF6ver tiden per n\xE4tverk: endast clearnet (IPv4, IPv6), darknet (Tor, I2p, cjdns) och b\xE5da.");
    ...
    prepareChartOptions(data, maxYAxis) {
      ...
      if (!this.widget && data.tor_nodes.length === 0) {
        ...
        title = {
          ...
          text: "Lightningnoder per n\xE4tverk",
          left: 'center',
          top: 0,
          zlevel: 10
        };
      ...
      const series = [{
        ...
        zlevel: 1,
        yAxisIndex: 0,
        name: "Endast Clearnet (IPv4, IPv6)",
        showSymbol: false,
        symbol: 'none',
        ...
        zlevel: 1,
        yAxisIndex: 0,
        name: "Endast Darknet (Tor, I2P, cjdns)",
        showSymbol: false,
        symbol: 'none',
        data: data.tor_nodes,
        type: 'line',
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightningnoder per n\xE4tverk";
        }
...
let NodesPerCountryChartComponent = /*#__PURE__*/(() => {
  class NodesPerCountryChartComponent {
    ...
    ngOnInit() {
      this.seoService.setTitle("Lightningnoder per land");
      this.seoService.setDescription("Se en geografisk uppdelning av Lightning-n\xE4tverket: hur m\xE5nga Lightning-noder som finns i l\xE4nder runt om i v\xE4rlden, sammanlagd BTC-kapacitet f\xF6r varje land och mer.");
    ...
    generateChartSerieData(country) {
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${country.name.en} (${country.share}%)</b><br>` + "" + nodeCount + " noder" + `<br>` + "" + this.amountShortenerPipe.transform(country.capacity / 100000000, 2) + " BTC-kapacitet";
            }
          },
          data: country.iso
        });
      ...
      data.push({
        ...
        name: "Annat (" + (totalShareOther.toFixed(2) + '%') + ")",
        label: {
          overflow: 'truncate',
          color: 'var(--tooltip-grey)',
          alignTo: 'edge',
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Annat (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + " noder";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightningnoder per land";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesPerCountry {
    ...
    ngOnInit() {
      this.nodes$ = this.apiService.getNodeForCountry$(this.route.snapshot.params.country).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_11__.tap)(() => this.isLoading = true), (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.map)(response => {
        this.seoService.setTitle("Lightningnoder p\xE5 " + response.country.en + "");
        this.seoService.setDescription("Utforska alla Lightning-noder som finns i " + response.country.en + " och se en \xF6versikt \xF6ver varje nods kapacitet, antal \xF6ppna kanaler och mer.");
        this.country = {
...
let NodesPerISPChartComponent = /*#__PURE__*/(() => {
  class NodesPerISPChartComponent {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("Lightningnoder per ISP");
        this.seoService.setDescription("Bl\xE4ddra bland de 100 b\xE4sta ISP:erna som \xE4r v\xE4rd f\xF6r Lightning-noder tillsammans med statistik som totalt antal noder per ISP, sammanlagd BTC-kapacitet per ISP och mer");
      }
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${isp[1]} (${this.sortBy === 'capacity' ? isp[7] : isp[6]}%)</b><br>` + "" + nodeCount + " noder" + `<br>` + "" + this.amountShortenerPipe.transform(isp[2] / 100000000, 2) + " BTC";
            }
          },
          data: isp[0]
        });
      ...
      data.push({
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "Annat (" + (totalShareOther.toFixed(2) + '%') + ")" + `</b><br>` + "" + nodeCount + " noder" + `<br>` + "" + this.amountShortenerPipe.transform(capacityOther / 100000000, 2) + " BTC";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Hur mycket likviditet k\xF6rs p\xE5 noder som annonserar minst en clearnet IP-adress";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "Antal likviditet p\xE5 noder som ISP inte var identifierbara";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "Likviditet p\xE5 noder som endast annonserar Tor-adresser";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Topp 100 internetleverant\xF6rer som \xE4r v\xE4rd f\xF6r LN-noder";
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_16 = "Indexering p\xE5g\xE5r";
        }
  ...
  class NodesPerISPPreview {
    ...
    ngOnInit() {
      this.nodes$ = this.route.paramMap.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_10__.switchMap)(params => {
        ...
        this.seoService.setTitle("Lightning-noder p\xE5 ISP: " + response.isp + " [AS " + this.route.snapshot.params.isp + "]");
        this.seoService.setDescription("Bl\xE4ddra bland alla Bitcoin Lightning-noder med " + response.isp + " [AS" + this.route.snapshot.params.isp + "] ISP och se aggregerad statistik som totalt antal noder, total kapacitet, och mer f\xF6r ISP.");
        for (const i in response.nodes) {
          response.nodes[i].geolocation = {
            country: response.nodes[i].country?.en,
            city: response.nodes[i].city?.en,
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_6 = "Fel vid laddning av data.";
        }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightningnoder p\xE5 ISP: " + "\uFFFD0\uFFFD" + "";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let OldestNodes = /*#__PURE__*/(() => {
  class OldestNodes {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("\xC4ldsta lightningnoderna");
        this.seoService.setDescription("Se de \xE4ldsta noderna p\xE5 Lightning-n\xE4tverket tillsammans med deras kapacitet, antal kanaler, plats osv.");
      }
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Topp 100 \xE4ldsta Lightningnoder";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let TopNodesPerCapacity = /*#__PURE__*/(() => {
  class TopNodesPerCapacity {
    ...
    ngOnInit() {
      ...
      if (!this.widget) {
        this.seoService.setTitle("Likviditetsrankning");
        this.seoService.setDescription("Se Lightning-noder med mest BTC-likviditet utplacerad tillsammans med statistik p\xE5 h\xF6g niv\xE5 som antal \xF6ppna kanaler, plats, nod\xE5lder och mer.");
      }
...
let TopNodesPerChannels = /*#__PURE__*/(() => {
  class TopNodesPerChannels {
    ...
    ngOnInit() {
      ...
      if (this.widget === false) {
        this.seoService.setTitle("Anslutningsrankning");
        this.seoService.setDescription("Se Lightning-noder med flest kanaler \xF6ppna tillsammans med statistik p\xE5 h\xF6g niv\xE5 som total nodkapacitet, nod\xE5lder och mer.");
...
let NodesRankingsDashboard = /*#__PURE__*/(() => {
  class NodesRankingsDashboard {
    ...
    ngOnInit() {
      this.seoService.setTitle("Topp lightningnoder");
      this.seoService.setDescription("Se de st\xF6rsta Lightning-n\xE4tverksnoderna rankade efter likviditet, anslutning och \xE5lder.");
  ...
  class LightningStatisticsChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("Lightning n\xE4tverkskapacitet");
        this.seoService.setDescription("Se Lightning-n\xE4tverkets kapacitet visualiserad \xF6ver tid i form av antalet \xF6ppna kanaler och total bitcoinkapacitet.");
        this.miningWindowPreference = this.miningService.getDefaultTimespan('all');
      }
      this.radioGroupForm = this.formBuilder.group({
        dateSpan: this.miningWindowPreference
    ...
    prepareChartOptions(data) {
      ...
      if (!this.widget && data.channel_count.length === 0) {
        ...
        title = {
          ...
          text: "Lightning n\xE4tverkskapacitet",
          left: 'center',
          top: 0,
          zlevel: 10
        };
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "Lightning n\xE4tverkskapacitet";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
