    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "" + "\uFFFD#2\uFFFD" + "mempool.space tillhandah\xE5ller bara data om Bitcoin-n\xE4tverket." + "\uFFFD/#2\uFFFD" + " Vi kan inte hj\xE4lpa dig med att f\xE5 tillbaka pengar, problem med pl\xE5nboken etc." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "F\xF6r s\xE5dana f\xF6rfr\xE5gningar m\xE5ste du kontakta den entitet som anv\xE4ndes f\xF6r att genomf\xF6ra transaktionen (pl\xE5nboksprogramvaran, handelsplatsf\xF6retag, etc)." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "";
        }
  ...
  class DocsComponent {
    ...
    ngDoCheck() {
      ...
      if (url[0].path === "faq") {
        ...
        this.seoService.setDescription("F\xE5 svar p\xE5 vanliga fr\xE5gor som: Vad \xE4r en mempool? Varf\xF6r bekr\xE4ftas inte min transaktion? Hur kan jag k\xF6ra min egen instans av Mempool Open Source Project? Och mer.");
        this.ogService.setManualOgImage('faq.jpg');
      } else if (url[1].path === "rest") {
        this.activeTab = 1;
        this.seoService.setTitle("REST API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokumentation f\xF6r REST API-tj\xE4nsten liquid.network: f\xE5 information om adresser, transaktioner, tillg\xE5ngar, block och mer.");
        } else {
          this.seoService.setDescription("Dokumentation f\xF6r tj\xE4nsten mempool.space REST API: f\xE5 information om adresser, transaktioner, block, avgifter, gruvdrift, Lightning-n\xE4tverket och mer.");
        }
      } else if (url[1].path === "websocket") {
        this.activeTab = 2;
        this.seoService.setTitle("WebSocket API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokumentation f\xF6r tj\xE4nsten liquid.network WebSocket API: f\xE5 realtidsinformation om block, mempooler, transaktioner, adresser och mer.");
        } else {
          this.seoService.setDescription("Dokumentation f\xF6r mempool.space WebSocket API-tj\xE4nsten: f\xE5 realtidsinformation om block, mempooler, transaktioner, adresser och mer.");
        }
      } else {
        this.activeTab = 3;
        this.seoService.setTitle("Electrum RPC");
        this.seoService.setDescription("Dokumentation f\xF6r v\xE5rt Electrum RPC-gr\xE4nssnitt: f\xE5 omedelbar, bekv\xE4m och p\xE5litlig \xE5tkomst till en Esplora-instans.");
      }
    }
    ngOnDestroy() {
