    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "" + "\uFFFD#2\uFFFD" + "mempool.space dostarcza jedynie dane o sieci Bitcoin." + "\uFFFD/#2\uFFFD" + " Nie mo\u017Ce pom\xF3c w odzyskaniu \u015Brodk\xF3w, problemach z portfelem itp." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "W przypadku takich pr\xF3\u015Bb nale\u017Cy si\u0119 z nami skontaktowa\u0107 z podmiotem, kt\xF3ry pom\xF3g\u0142 w dokonaniu transakcji (oprogramowanie portfela, firma zajmuj\u0105ca si\u0119 wymian\u0105 itp.)." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "";
        }
  ...
  class DocsComponent {
    ...
    ngDoCheck() {
      ...
      if (url[0].path === "faq") {
        ...
        this.seoService.setDescription("Znajd\u017A odpowiedzi na cz\u0119sto zadawane pytania, takie jak: Co to jest mempool? Dlaczego moja transakcja nie zostaje potwierdzona? Jak mog\u0119 uruchomi\u0107 w\u0142asn\u0105 instancj\u0119 Projektu Open Source The Mempool? I inne.");
        this.ogService.setManualOgImage('faq.jpg');
      } else if (url[1].path === "rest") {
        this.activeTab = 1;
        this.seoService.setTitle("REST API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokumentacja dla us\u0142ugi REST API liquid.network: uzyskaj informacje o adresach, transakcjach, aktywach, blokach i wi\u0119cej.");
        } else {
          this.seoService.setDescription("Dokumentacja dla us\u0142ugi REST API mempool.space: uzyskaj informacje o adresach, transakcjach, blokach, op\u0142atach, wydobyciu, sieci Lightning i wi\u0119cej.");
        }
      } else if (url[1].path === "websocket") {
        this.activeTab = 2;
        this.seoService.setTitle("WebSocket API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokumentacja dla us\u0142ugi WebSocket API liquid.network: uzyskuj informacje w czasie rzeczywistym o blokach, mempoolach, transakcjach, adresach i wi\u0119cej.");
        } else {
          this.seoService.setDescription("Dokumentacja dla us\u0142ugi WebSocket API mempool.space: uzyskuj informacje w czasie rzeczywistym o blokach, mempoolach, transakcjach, adresach i wi\u0119cej.");
        }
      } else {
        this.activeTab = 3;
        this.seoService.setTitle("Electrum RPC");
        this.seoService.setDescription("Dokumentacja naszego interfejsu Electrum RPC: uzyskaj natychmiastowy, wygodny i niezawodny dost\u0119p do instancji Esplora.");
      }
    }
    ngOnDestroy() {
