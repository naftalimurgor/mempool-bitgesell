    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_5 = "\u0422\u0435\u0440\u043C\u0456\u043D \u0434\u0456\u0457 \u0437\u0430\u043A\u0456\u043D\u0447\u0443\u0454\u0442\u044C\u0441\u044F \u0447\u0435\u0440\u0435\u0437";
        }
        let i18n_6;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let FederationWalletComponent = /*#__PURE__*/(() => {
  class FederationWalletComponent {
    constructor(seoService) {
      ...
      this.seoService.setTitle("\u0413\u0430\u043C\u0430\u043D\u0435\u0446\u044C \u0444\u0435\u0434\u0435\u0440\u0430\u0446\u0456\u0457 Liquid");
    }
    ngOnInit() {}
    isExpiredFragment() {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "\u0413\u0430\u043C\u0430\u043D\u0435\u0446\u044C \u0444\u0435\u0434\u0435\u0440\u0430\u0446\u0456\u0457 Liquid";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "UTXO \u0437 \u043F\u0440\u043E\u0441\u0442\u0440\u043E\u0447\u0435\u043D\u0438\u043C \u0442\u0430\u0439\u043C\u043B\u043E\u043A\u043E\u043C";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let RecentPegsListComponent = /*#__PURE__*/(() => {
  class RecentPegsListComponent {
    ...
    ngOnInit() {
      ...
      this.skeletonLines = this.widget === true ? [...Array(5).keys()] : [...Array(15).keys()];
      if (!this.widget) {
        this.seoService.setTitle("\u041D\u0435\u0449\u043E\u0434\u0430\u0432\u043D\u0456 \u043F\u0440\u0438\u0432'\u044F\u0437\u043A\u0438/\u0432\u0456\u0434\u0432'\u044F\u0437\u043A\u0438");
        this.websocketService.want(['blocks']);
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "\u041D\u0435\u0449\u043E\u0434\u0430\u0432\u043D\u0456 \u043F\u0440\u0438\u0432'\u044F\u0437\u043A\u0438/\u0432\u0456\u0434\u0432'\u044F\u0437\u043A\u0438";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_4 = "\u0422\u0440\u0430\u043D\u0437\u0430\u043A\u0446\u0456\u044F \u0444\u0456\u043D\u0430\u043D\u0441\u0443\u0432\u0430\u043D\u043D\u044F/\u043F\u043E\u0433\u0430\u0448\u0435\u043D\u043D\u044F";
        }
        let i18n_5;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
