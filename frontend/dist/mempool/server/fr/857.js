    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Une erreur est survenue lors du chargement.";
        }
  ...
  class BlockComponent {
    ...
    ngOnInit() {
      ...
      this.block$ = this.route.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.switchMap)(params => {
        ...
        this.setNextAndPreviousBlockLink();
        this.seoService.setTitle("Bloc " + block.height + " : " + block.id + "");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Consultez la taille, le poids, la fourchette de frais, les transactions incluses et bien plus encore pour le bloc Liquid" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " " + block.height + " (" + block.id + ").");
        } else {
          this.seoService.setDescription("Consultez la taille, le poids, la fourchette de frais, les transactions incluses, l'audit (attendu et r\xE9el) et bien plus encore pour le bloc Bitcoin" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " " + block.height + " ( " + block.id + ").");
        }
        this.isLoadingBlock = false;
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Ce bloc n'appartient pas \xE0 la cha\xEEne principale, il a \xE9t\xE9 remplac\xE9 par :";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_30 = "Hex d'en-t\xEAte de bloc ";
        }
        let i18n_31;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_34 = "Erreur lors du chargement du bloc.";
        }
        let i18n_35;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_35 = "Pourquoi ce bloc est-il vide ?";
        }
        let i18n_36;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_39 = "Frais d'acc\xE9l\xE9ration pay\xE9s hors bande";
        }
        let i18n_40;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
