    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "" + "\uFFFD#2\uFFFD" + "mempool.space csup\xE1n adatot szolg\xE1ltat a Bitcoin h\xE1l\xF3zatr\xF3l." + "\uFFFD/#2\uFFFD" + " Nem tud seg\xEDteni t\u0151ke helyre\xE1ll\xEDt\xE1sban, t\xE1rca probl\xE9m\xE1val, stb." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "Minden ehhez hasonl\xF3 esetben fordulj ahhoz az alanyhoz aki seg\xEDtett a kapcsol\xF3d\xF3 tranzakci\xF3 l\xE9trehoz\xE1s\xE1ban (t\xE1rca alkalmaz\xE1s, v\xE1lt\xF3- vagy br\xF3kerc\xE9g, stb)." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "";
        }
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_1 = "REST API szolg\xE1ltat\xE1s";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Csomag telep\xEDt\xE9se";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let DocsComponent = /*#__PURE__*/(() => {
  class DocsComponent {
    ...
    ngDoCheck() {
      ...
      if (url[0].path === "faq") {
        this.activeTab = 0;
        this.seoService.setTitle("GYIK");
        this.seoService.setDescription("Kapj v\xE1laszt gyakran felmer\xFCl\u0151 k\xE9rd\xE9sekre mint: Mi az a mempool? Mi\xE9rt nem kap meger\u0151s\xEDt\xE9st a tranzakci\xF3m? Hogyan tudok saj\xE1t p\xE9ld\xE1nyt futtatni a Mempool ny\xEDl forr\xE1s\xFA projektb\u0151l? \xC9s sok m\xE1s.");
        this.ogService.setManualOgImage('faq.jpg');
      } else if (url[1].path === "rest") {
        this.activeTab = 1;
        this.seoService.setTitle("REST API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokument\xE1ci\xF3 a liquid.network REST API szolg\xE1ltat\xE1shoz: kapj inf\xF3t c\xEDmekr\u0151l, tranzakci\xF3kr\xF3l, eszk\xF6z\xF6kr\u0151l, blokkokr\xF3l \xE9s sok egy\xE9br\u0151l.");
        } else {
          this.seoService.setDescription("Dokument\xE1ci\xF3 a mempool.space REST API szolg\xE1ltat\xE1shoz: kapj inf\xF3t c\xEDmekr\u0151l, tranzakci\xF3kr\xF3l, blokkokr\xF3l, d\xEDjakr\xF3l, b\xE1ny\xE1szokr\xF3l, a Lightning h\xE1l\xF3zatr\xF3l \xE9s sok egy\xE9br\u0151l.");
        }
      } else if (url[1].path === "websocket") {
        this.activeTab = 2;
        this.seoService.setTitle("WebSocket API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokument\xE1ci\xF3 a liquid.network WebSocket API szolg\xE1ltat\xE1shoz: kapj val\xF3s idej\u0171 inf\xF3t blokkokr\xF3l, mempool-r\xF3l, tranzakci\xF3kr\xF3l, c\xEDmekr\u0151l \xE9s sok egy\xE9br\u0151l.");
        } else {
          this.seoService.setDescription("Dokument\xE1ci\xF3 a mempool.space WebSocket API szolg\xE1ltat\xE1shoz: kapj val\xF3s idej\xFA inf\xF3t blokkokr\xF3l, mempool-r\xF3l, tranzakci\xF3kr\xF3l, c\xEDmekr\u0151l \xE9s sok egy\xE9br\u0151l.");
        }
      } else {
        this.activeTab = 3;
        this.seoService.setTitle("Electrum RPC");
        this.seoService.setDescription("Dokument\xE1ci\xF3 az Electrum RPC fel\xFClet\xFCnkh\xF6z: kapj azonnali, k\xE9nyelmes \xE9s megb\xEDzhat\xF3 hozz\xE1f\xE9r\xE9st egy Espora csom\xF3ponthoz.");
      }
    }
    ngOnDestroy() {
