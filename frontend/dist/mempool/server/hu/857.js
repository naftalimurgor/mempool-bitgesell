    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Hiba t\xF6rt\xE9nt az adatok bet\xF6lt\xE9sekor.";
        }
  ...
  class BlockComponent {
    ...
    ngOnInit() {
      ...
      this.block$ = this.route.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.switchMap)(params => {
        ...
        this.setNextAndPreviousBlockLink();
        this.seoService.setTitle("Blokk " + block.height + ": " + block.id + "");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("N\xE9zd meg a m\xE9ret\xE9t, s\xFAly\xE1t, d\xEDjtartom\xE1ny\xE1t, kapcsol\xF3d\xF3 tranzakci\xF3kat \xE9s sok m\xE1st ennek a Liquid" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " blokknak " + block.height + " (" + block.id + ").");
        } else {
          this.seoService.setDescription("N\xE9zd meg a m\xE9ret\xE9t, s\xFAly\xE1t, d\xEDjtartom\xE1ny\xE1t, kapcsol\xF3d\xF3 tranzakci\xF3kat, elemz\xE9s\xE9t (v\xE1rt / t\xE9nyleges) \xE9s sok m\xE1st ennek a Bitcoin" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " blokknak " + block.height + " (" + block.id + ").");
        }
        this.isLoadingBlock = false;
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Ez a blokk nem tartozik a f\u0151l\xE1nchoz, le lett cser\xE9lve ezzel:";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_34 = "Hiba a blokk adat bet\xF6lt\xE9sekor.";
        }
        let i18n_35;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_35 = "Mi\xE9rt \xFCres ez a blokk?";
        }
        let i18n_36;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_39 = "Gyors\xEDt\xE1si d\xEDjak s\xE1von k\xEDv\xFCl fizetve";
        }
        let i18n_40;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
