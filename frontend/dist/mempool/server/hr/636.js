    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "" + "\uFFFD#2\uFFFD" + "mempool.space samo pru\u017Ea podatke o Bitcoin mre\u017Ei." + "\uFFFD/#2\uFFFD" + " Ne mo\u017Ee vam pomo\u0107i s vra\u0107anjem sredstava, problemima s nov\u010Danikom itd." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "Za sve takve zahtjeve morate se obratiti entitetu koji je pomogao u transakciji (softver za nov\u010Danik, mjenja\u010Dnica itd.)." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "";
        }
  ...
  class DocsComponent {
    ...
    ngDoCheck() {
      ...
      if (url[0].path === "faq") {
        ...
        this.seoService.setDescription("Dobijte odgovore na uobi\u010Dajena pitanja poput: \u0160to je mempool? Za\u0161to se moja transakcija ne potvr\u0111uje? Kako mogu pokrenuti vlastitu instancu projekta otvorenog koda Mempool? I vi\u0161e od toga.");
        this.ogService.setManualOgImage('faq.jpg');
      } else if (url[1].path === "rest") {
        this.activeTab = 1;
        this.seoService.setTitle("REST API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokumentacija za REST API uslugu liquid.network: saznajte informacije o adresama, transakcijama, imovini, blokovima i vi\u0161e.");
        } else {
          this.seoService.setDescription("Dokumentacija za mempool.space REST API uslugu: saznajte informacije o adresama, transakcijama, blokovima, naknadama, rudarenju, Lightning mre\u017Ei i vi\u0161e.");
        }
      } else if (url[1].path === "websocket") {
        this.activeTab = 2;
        this.seoService.setTitle("WebSocket API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Dokumentacija za liquid.network WebSocket API uslugu: dobijte informacije u stvarnom vremenu o blokovima, mempoolima, transakcijama, adresama i vi\u0161e.");
        } else {
          this.seoService.setDescription("Dokumentacija za mempool.space WebSocket API uslugu: dobijte informacije u stvarnom vremenu o blokovima, mempoolima, transakcijama, adresama i vi\u0161e.");
        }
      } else {
        this.activeTab = 3;
        this.seoService.setTitle("Electrum RPC");
        this.seoService.setDescription("Dokumentacija za na\u0161e Electrum RPC su\u010Delje: dobijte trenutan, prakti\u010Dan i pouzdan pristup Esplora instanci.");
      }
    }
    ngOnDestroy() {
