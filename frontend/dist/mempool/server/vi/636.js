    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "" + "\uFFFD#2\uFFFD" + "mempool.space merely provides data about the Bitcoin network." + "\uFFFD/#2\uFFFD" + " It cannot help you with retrieving funds, wallet issues, etc." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "For any such requests, you need to get in touch with the entity that helped make the transaction (wallet software, exchange company, etc)." + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "";
        }
  ...
  class DocsComponent {
    ...
    ngDoCheck() {
      ...
      if (url[0].path === "faq") {
        ...
        this.seoService.setDescription("Nh\u1EEFng c\xE2u h\u1ECFi th\u01B0\u1EDDng g\u1EB7p nh\u01B0: Mempool l\xE0 g\xEC? T\u1EA1i sao giao d\u1ECBch c\u1EE7a t\xF4i ch\u01B0a \u0111\u01B0\u1EE3c x\xE1c nh\u1EADn? L\xE0m sao \u0111\u1EC3 v\u1EADn h\xE0nh m\u1ED9t phi\xEAn b\u1EA3n Mempool M\xE3 ngu\u1ED3n m\u1EDF ri\xEAng? V\xE2n v\xE2n.");
        this.ogService.setManualOgImage('faq.jpg');
      } else if (url[1].path === "rest") {
        this.activeTab = 1;
        this.seoService.setTitle("RESP API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("T\xE0i li\u1EC7u cho d\u1ECBch v\u1EE5 REST API liquid.network: th\xF4ng tin v\u1EC1 c\xE1c \u0111\u1ECBa ch\u1EC9, giao d\u1ECBch, t\xE0i s\u1EA3n, kh\u1ED1i v\xE0 nhi\u1EC1u th\xF4ng tin kh\xE1c.");
        } else {
          this.seoService.setDescription("T\xE0i li\u1EC7u cho d\u1ECBch v\u1EE5 REST API mempool.space: th\xF4ng tin v\u1EC1 c\xE1c \u0111ia ch\u1EC9, giao d\u1ECBch, kh\u1ED1i, ph\xED, \u0111\xE0o, m\u1EA1ng Lightning v\xE0 nhi\u1EC1u th\xF4ng tin kh\xE1c.");
        }
      } else if (url[1].path === "websocket") {
        this.activeTab = 2;
        this.seoService.setTitle("WebSocket API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Documentation for the liquid.network WebSocket API service: get real-time info on blocks, mempools, transactions, addresses, and more.");
        } else {
          this.seoService.setDescription("Documentation for the mempool.space WebSocket API service: get real-time info on blocks, mempools, transactions, addresses, and more.");
        }
      } else {
        this.activeTab = 3;
        this.seoService.setTitle("Electrum RPC");
        this.seoService.setDescription("T\xE0i li\u1EC7u cho giao di\u1EC7n Electrum RPC c\u1EE7a ch\xFAng t\xF4i: nh\u1EADn quy\u1EC1n truy c\u1EADp t\u1EE9c th\xEC, thu\u1EADn ti\u1EC7n v\xE0 tin c\u1EADy v\xE0o phi\xEAn b\u1EA3n Esplora.");
      }
    }
    ngOnDestroy() {
