    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "" + "\uFFFD#2\uFFFD" + "mempool.space Bitcoin a\u011F\u0131 hakk\u0131nda sadece bilgi sa\u011Flar. " + "\uFFFD/#2\uFFFD" + "kaybetti\u011Finiz fonlar\u0131, c\xFCzdanlar ile ya\u015Fad\u0131\u011F\u0131n\u0131z sorunlar\u0131 \xE7\xF6zmekte yard\u0131mc\u0131 olamaz. " + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "\u0130\u015Flemler ile ilgili sorun ya\u015Farsan\u0131z bu i\u015Flemi ger\xE7ekle\u015Ftirdi\u011Finiz entite ile ileti\u015Fime ge\xE7meniz gerekir. (c\xFCzdan yaz\u0131l\u0131m\u0131, borsa vb)" + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "";
        }
...
let DocsComponent = /*#__PURE__*/(() => {
  class DocsComponent {
    ...
    ngDoCheck() {
      ...
      if (url[0].path === "faq") {
        this.activeTab = 0;
        this.seoService.setTitle("SSS");
        this.seoService.setDescription("Mempool nedir, neden i\u015Flemim onaylanm\u0131yor, A\xE7\u0131k Kaynak Kodlu Mempool projesinin bir kopyas\u0131n\u0131 nas\u0131l \xE7al\u0131\u015Ft\u0131rabilirim? gibi temel sorulara cevaplar bulun.");
        this.ogService.setManualOgImage('faq.jpg');
      } else if (url[1].path === "rest") {
        this.activeTab = 1;
        this.seoService.setTitle("REST API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("liquid.network REST API servisi d\xF6k\xFCmantasyonu: adresler ile ilgili bilgi al, i\u015Flemler, varl\u0131klar, bloklar ve daha fazlas\u0131. ");
        } else {
          this.seoService.setDescription("mempool.space REST API servisi d\xF6k\xFCmantasyonu: adresler ile ilgili bilgi al, i\u015Flemler, bloklar, \xFCcretler, madencilik, Lightning a\u011F\u0131 ve daha fazlas\u0131. ");
        }
      } else if (url[1].path === "websocket") {
        this.activeTab = 2;
        this.seoService.setTitle("WebSocket API ");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("liquid.network WEBSOKET API servisi d\xF6k\xFCmantasyonu: adresler ile ilgili anl\u0131k bilgi al, i\u015Flemler, varl\u0131klar, bloklar ve daha fazlas\u0131. ");
        } else {
          this.seoService.setDescription("Mempool.space Websoket API servisi i\xE7in, bloklardan ger\xE7ek-zamanl\u0131 bilgi \xE7ek, mempoollar, i\u015Flemler, adresler vb talepler i\xE7in d\xF6k\xFCmantasyon. ");
        }
      } else {
        this.activeTab = 3;
        this.seoService.setTitle("Electrum RPC ");
        this.seoService.setDescription("Electrum RPC i\xE7in aray\xFCz d\xF6k\xFCmantasyonu: Esplora'ya an\u0131nda, kolayca ve emniyetli bir \u015Fekilde ula\u015F\u0131n. ");
      }
    }
    ngOnDestroy() {
