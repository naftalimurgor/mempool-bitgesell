    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Veriyi y\xFCklerken hata olu\u015Ftu";
        }
    ...
    ngOnInit() {
      ...
      this.block$ = this.route.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.switchMap)(params => {
        ...
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Liquid " + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " blo\u011Fundaki " + block.height + " (" + block.id + ") boyut, a\u011F\u0131rl\u0131k, \xFCcret aral\u0131\u011F\u0131, dahil edilen i\u015Flemler ve daha fazlas\u0131n\u0131 g\xF6r.");
        } else {
          this.seoService.setDescription("Bitcoin " + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " block " + block.height + "(" + block.id + ") i\xE7in boyut, a\u011F\u0131rl\u0131klar, \xFCcret aral\u0131\u011F\u0131, dahili i\u015Flemler, denetim (beklene vs ger\xE7ek) ve daha fazlas\u0131n\u0131 g\xF6r.");
        }
        this.isLoadingBlock = false;
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Bu blok ana-zincire dahil de\u011Fil ve \u015Fununla de\u011Fi\u015Ftirilebilir: ";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_34 = "Blok datas\u0131 y\xFCklenirken hata olu\u015Ftu.";
        }
        let i18n_35;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_39 = "H\u0131zland\u0131rma \xFCcretleri bant-d\u0131\u015F\u0131nda \xF6dendi";
        }
        let i18n_40;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
