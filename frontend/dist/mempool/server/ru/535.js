...
let FederationWalletComponent = /*#__PURE__*/(() => {
  class FederationWalletComponent {
    constructor(seoService) {
      ...
      this.seoService.setTitle("\u041A\u043E\u0448\u0435\u043B\u0451\u043A Liquid Federation");
    }
    ngOnInit() {}
    isExpiredFragment() {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "\u041A\u043E\u0448\u0435\u043B\u0451\u043A Liquid Federation";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "UTXO \u0441 \u0438\u0441\u0442\u0435\u043A\u0448\u0438\u043C \u0441\u0440\u043E\u043A\u043E\u043C \u0432\u0440\u0435\u043C\u0435\u043D\u043D\xF3\u0439 \u0431\u043B\u043E\u043A\u0438\u0440\u043E\u0432\u043A\u0438.";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let RecentPegsListComponent = /*#__PURE__*/(() => {
  class RecentPegsListComponent {
    ...
    ngOnInit() {
      ...
      this.skeletonLines = this.widget === true ? [...Array(5).keys()] : [...Array(15).keys()];
      if (!this.widget) {
        this.seoService.setTitle("\u041D\u0435\u0434\u0430\u0432\u043D\u0438\u0435 \u043F\u0440\u0438\u0432\u044F\u0437\u043A\u0438 / \u043E\u0442\u0432\u044F\u0437\u043A\u0438");
        this.websocketService.want(['blocks']);
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_3 = "\u041D\u0435\u0434\u0430\u0432\u043D\u0438\u0435 \u043F\u0440\u0438\u0432\u044F\u0437\u043A\u0438 / \u043E\u0442\u0432\u044F\u0437\u043A\u0438";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_4 = "\u0422\u0440\u0430\u043D\u0437\u0430\u043A\u0446\u0438\u0438 \u043F\u043E\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u044F / \u043F\u043E\u0433\u0430\u0448\u0435\u043D\u0438\u044F";
        }
        let i18n_5;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
