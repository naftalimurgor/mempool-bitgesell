    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Fejl ved indl\xE6sning af data.";
        }
    ...
    ngOnInit() {
      ...
      this.block$ = this.route.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.switchMap)(params => {
        ...
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("Se st\xF8rrelse, v\xE6gt, gebyromr\xE5de, inkluderede transaktioner og mere for Liquid" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " blok " + block.height + " (" + block.id + ").");
        } else {
          this.seoService.setDescription("Se st\xF8rrelse, v\xE6gt, gebyrinterval, inkluderede transaktioner, revision (forventet v faktisk) og mere for Bitcoin" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " blok " + block.height + " ( " + block.id + ").");
        }
        this.isLoadingBlock = false;
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "Denne blok tilh\xF8rer ikke hovedk\xE6den, den er blevet erstattet af:";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_34 = "Fejl ved indl\xE6sning af blokdata.";
        }
        let i18n_35;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_35 = "Hvorfor er denne blok tom?";
        }
        let i18n_36;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_39 = "Accelerationsgebyrer betalt ved siden af";
        }
        let i18n_40;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
