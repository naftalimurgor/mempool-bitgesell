    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "" + "\uFFFD#2\uFFFD" + "mempool.space \u4EC5\u63D0\u4F9B\u6709\u5173\u6BD4\u7279\u5E01\u7F51\u7EDC\u7684\u6570\u636E\u3002" + "\uFFFD/#2\uFFFD" + "\u5B83\u65E0\u6CD5\u5E2E\u52A9\u60A8\u68C0\u7D22\u8D44\u91D1\u3001\u89E3\u51B3\u94B1\u5305\u95EE\u9898\u7B49\u3002" + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "" + "[\uFFFD#1\uFFFD|\uFFFD#3\uFFFD]" + "\u5BF9\u4E8E\u4EFB\u4F55\u6B64\u7C7B\u8BF7\u6C42\uFF0C\u60A8\u90FD\u9700\u8981\u8054\u7CFB\u5E2E\u52A9\u8FDB\u884C\u4EA4\u6613\u7684\u5B9E\u4F53\uFF08\u94B1\u5305\u8F6F\u4EF6\u3001\u4EA4\u6613\u6240\u7B49\uFF09\u3002" + "[\uFFFD/#1\uFFFD|\uFFFD/#3\uFFFD]" + "";
        }
...
let DocsComponent = /*#__PURE__*/(() => {
  class DocsComponent {
    ...
    ngDoCheck() {
      ...
      if (url[0].path === "faq") {
        this.activeTab = 0;
        this.seoService.setTitle("\u5E38\u89C1\u95EE\u9898");
        this.seoService.setDescription("\u83B7\u53D6\u5E38\u89C1\u95EE\u9898\u7684\u7B54\u6848\uFF0C\u4F8B\u5982\uFF1A\u4EC0\u4E48\u662FMempool\uFF1F\u4E3A\u4EC0\u4E48\u6211\u7684\u4EA4\u6613\u672A\u88AB\u786E\u8BA4\uFF1F\u5982\u4F55\u8FD0\u884C\u81EA\u5DF1\u7684Mempool\u5F00\u6E90\u9879\u76EE\u5B9E\u4F8B\uFF1F\u7B49\u7B49\u3002");
        this.ogService.setManualOgImage('faq.jpg');
      } else if (url[1].path === "rest") {
        this.activeTab = 1;
        this.seoService.setTitle("REST API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("liquid.network REST API \u670D\u52A1\u6587\u6863\uFF1A\u83B7\u53D6\u6709\u5173\u5730\u5740\u3001\u4EA4\u6613\u3001\u8D44\u4EA7\u3001\u533A\u5757\u7B49\u7684\u4FE1\u606F\u3002");
        } else {
          this.seoService.setDescription("mempool.space REST API \u670D\u52A1\u6587\u6863\uFF1A\u83B7\u53D6\u6709\u5173\u5730\u5740\u3001\u4EA4\u6613\u3001\u533A\u5757\u3001\u8D39\u7528\u3001\u6316\u77FF\u3001\u95EA\u7535\u7F51\u7EDC\u7B49\u7684\u4FE1\u606F\u3002");
        }
      } else if (url[1].path === "websocket") {
        this.activeTab = 2;
        this.seoService.setTitle("Websocket API");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("liquid.network WebSocket API \u670D\u52A1\u6587\u6863\uFF1A\u83B7\u53D6\u6709\u5173\u5757\u3001\u5185\u5B58\u6C60\u3001\u4EA4\u6613\u3001\u5730\u5740\u7B49\u7684\u5B9E\u65F6\u4FE1\u606F\u3002");
        } else {
          this.seoService.setDescription("mempool.space WebSocket API \u670D\u52A1\u6587\u6863\uFF1A\u83B7\u53D6\u6709\u5173\u5757\u3001\u5185\u5B58\u6C60\u3001\u4EA4\u6613\u3001\u5730\u5740\u7B49\u7684\u5B9E\u65F6\u4FE1\u606F\u3002");
        }
      } else {
        this.activeTab = 3;
        this.seoService.setTitle("Electrum RPC");
        this.seoService.setDescription("\u6211\u4EEC\u7684 Electrum RPC \u63A5\u53E3\u6587\u6863\uFF1A\u5373\u65F6\u3001\u65B9\u4FBF\u3001\u53EF\u9760\u5730\u8BBF\u95EE Esplora \u5B9E\u4F8B\u3002");
      }
    }
    ngOnDestroy() {
