  ...
  class BlockComponent {
    ...
    ngOnInit() {
      ...
      this.block$ = this.route.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.switchMap)(params => {
        ...
        this.setNextAndPreviousBlockLink();
        this.seoService.setTitle("\u533A\u5757 " + block.height + "\uFF1A" + block.id + "");
        if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet') {
          this.seoService.setDescription("\u67E5\u770B Liquid" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + " \u533A\u5757 " + block.height + " (" + block.id + ") \u7684\u5927\u5C0F\u3001\u91CD\u91CF\u3001\u8D39\u7528\u8303\u56F4\u3001\u5305\u542B\u7684\u4EA4\u6613\u7B49\u4FE1\u606F\u3002");
        } else {
          this.seoService.setDescription("\u67E5\u770B\u6BD4\u7279\u5E01" + (0, _app_shared_common_utils__WEBPACK_IMPORTED_MODULE_2__.seoDescriptionNetwork)(this.stateService.network) + "\u533A\u5757" + block.height + " (" + block.id + ") \u7684\u5927\u5C0F\u3001\u6743\u91CD\u3001\u8D39\u7528\u8303\u56F4\u3001\u5305\u542B\u7684\u4EA4\u6613\u3001\u5BA1\u8BA1\uFF08\u9884\u671F\u4E0E\u5B9E\u9645\uFF09\u7B49\u4FE1\u606F\u3002");
        }
        this.isLoadingBlock = false;
