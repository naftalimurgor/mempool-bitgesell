  ...
  class ChannelPreviewComponent {
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.switchMap)(params => {
        ...
        this.seoService.setDescription("\u95EA\u7535\u901A\u9053 " + params.get('short_id') + " \u6982\u89C8\u3002\u67E5\u770B\u901A\u9053\u5BB9\u91CF\u3001\u6D89\u53CA\u7684\u95EA\u7535\u8282\u70B9\u3001\u76F8\u5173\u7684\u94FE\u4E0A\u4EA4\u6613\u7B49\u3002");
    ...
    ngOnInit() {
      this.channel$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.switchMap)(params => {
        ...
        return this.lightningApiService.getChannel$(params.get('short_id')).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.tap)(value => {
          this.seoService.setTitle("\u9891\u9053\uFF1A" + value.short_id + "");
          this.seoService.setDescription("\u95EA\u7535\u901A\u9053 " + value.short_id + " \u6982\u89C8\u3002\u67E5\u770B\u901A\u9053\u5BB9\u91CF\u3001\u6D89\u53CA\u7684\u95EA\u7535\u8282\u70B9\u3001\u76F8\u5173\u7684\u94FE\u4E0A\u4EA4\u6613\u7B49\u3002");
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_2 = "\u8282\u70B9\u5E73\u5747\u8D39\u7387\uFF0C\u6392\u9664\u8D39\u7387\u5927\u4E8E 0.5% \u6216 5000ppm \u7684\u8282\u70B9";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_3 = "\u8282\u70B9\u5E73\u5747\u57FA\u7840\u8D39\u7387\uFF0C\u6392\u9664\u8D39\u7387\u5927\u4E8E 5000ppm \u7684\u8282\u70B9";
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_10 = "\u8282\u70B9\u4E2D\u4F4D\u8D39\u7387\uFF0C\u6392\u9664\u8D39\u7387\u5927\u4E8E 0.5% \u6216 5000ppm \u7684\u8282\u70B9";
        }
        let i18n_11;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_11 = "\u8282\u70B9\u4E2D\u4F4D\u57FA\u7840\u8D39\u7387\uFF0C\u6392\u9664\u8D39\u7387\u5927\u4E8E 5000ppm \u7684\u8282\u70B9";
        }
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
...
let LightningDashboardComponent = /*#__PURE__*/(() => {
  class LightningDashboardComponent {
    ...
    ngOnInit() {
      this.onResize();
      this.seoService.setTitle("\u95EA\u7535\u7F51\u7EDC\u6D4F\u89C8\u5668");
      this.seoService.setDescription("\u83B7\u53D6\u6709\u5173\u95EA\u7535\u7F51\u7EDC\uFF08\u603B\u5BB9\u91CF\u3001\u8FDE\u63A5\u6027\u7B49\uFF09\u3001\u95EA\u7535\u8282\u70B9\uFF08\u6E20\u9053\u3001\u6D41\u52A8\u6027\u7B49\uFF09\u548C\u95EA\u7535\u901A\u9053\uFF08\u72B6\u6001\u3001\u8D39\u7528\u7B49\uFF09\u7684\u7EDF\u8BA1\u6570\u636E\u3002");
  ...
  class NodePreviewComponent {
    ...
    ngOnInit() {
      this.node$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.switchMap)(params => {
        ...
        this.seoService.setDescription("\u95EA\u7535\u7F51\u7EDC\u8282\u70B9 " + node.alias + " \u7684\u6982\u89C8\u3002\u67E5\u770B\u901A\u9053\u3001\u5BB9\u91CF\u3001\u4F4D\u7F6E\u3001\u8D39\u7528\u7EDF\u8BA1\u7B49\u3002");
        const socketsObject = [];
  ...
  class NodeComponent {
    ...
    ngOnInit() {
      this.node$ = this.activatedRoute.paramMap.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_22__.switchMap)(params => {
        ...
        this.seoService.setTitle("\u8282\u70B9\uFF1A" + node.alias + "");
        this.seoService.setDescription("\u95EA\u7535\u7F51\u7EDC\u8282\u70B9 " + node.alias + " \u7684\u6982\u89C8\u3002\u67E5\u770B\u901A\u9053\u3001\u5BB9\u91CF\u3001\u4F4D\u7F6E\u3001\u8D39\u7528\u7EDF\u8BA1\u7B49\u3002");
        this.clearnetSocketCount = 0;
        this.torSocketCount = 0;
        const socketsObject = [];
...
let NodesChannelsMap = /*#__PURE__*/(() => {
  class NodesChannelsMap {
    ...
    ngOnInit() {
      ...
      if (this.style === 'graph') {
        this.center = [0, 5];
        this.seoService.setTitle("\u95EA\u7535\u7F51\u7EDC\u9891\u7387\u4E16\u754C\u5730\u56FE");
        this.seoService.setDescription("\u5728\u4E16\u754C\u5730\u56FE\u4E0A\u67E5\u770B\u975ETor\u7684\u95EA\u7535\u7F51\u7EDC\u8282\u70B9\u7684\u901A\u9053\u3002\u5C06\u9F20\u6807\u60AC\u505C/\u70B9\u51FB\u5730\u56FE\u4E0A\u7684\u70B9\u53EF\u67E5\u770B\u8282\u70B9\u540D\u79F0\u548C\u8BE6\u7EC6\u4FE1\u606F\u3002");
      }
...
let NodesMap = /*#__PURE__*/(() => {
  class NodesMap {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("\u95EA\u7535\u7F51\u7EDC\u8282\u70B9\u5168\u7403\u5730\u56FE");
        this.seoService.setDescription("\u5728\u4E16\u754C\u5730\u56FE\u4E0A\u67E5\u770B\u975E Tor\u7684\u95EA\u7535\u7F51\u7EDC\u8282\u70B9\u7684\u901A\u9053\u3002\u5C06\u9F20\u6807\u60AC\u505C/\u70B9\u51FB\u5730\u56FE\u4E0A\u7684\u70B9\u53EF\u67E5\u770B\u8282\u70B9\u540D\u79F0\u548C\u8BE6\u7EC6\u4FE1\u606F\u3002");
      }
      if (!this.inputNodes$) {
  ...
  class NodesNetworksChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("\u95EA\u7535\u7F51\u7EDC\u8282\u70B9\u7F51\u7EDC\u5206\u5E03");
        this.seoService.setDescription("\u67E5\u770B\u6309\u7F51\u7EDC\u968F\u65F6\u95F4\u53D8\u5316\u7684\u95EA\u7535\u7F51\u7EDC\u8282\u70B9\u6570\u91CF\uFF1A\u4EC5\u660E\u7F51\uFF08IPv4\u3001IPv6\uFF09\u3001\u6697\u7F51\uFF08Tor\u3001I2p\u3001cjdns\uFF09\u4EE5\u53CA\u4E24\u8005\u5747\u5305\u542B\u5728\u5185\u3002");
...
let NodesPerCountryChartComponent = /*#__PURE__*/(() => {
  class NodesPerCountryChartComponent {
    ...
    ngOnInit() {
      this.seoService.setTitle("\u95EA\u7535\u7F51\u7EDC\u8282\u70B9\u6309\u56FD\u5BB6\u6216\u5730\u533A\u6392\u5E8F");
      this.seoService.setDescription("\u67E5\u770B\u95EA\u7535\u7F51\u7EDC\u7684\u5730\u7406\u5206\u5E03\uFF1A\u4E16\u754C\u5404\u56FD\u6258\u7BA1\u7740\u591A\u5C11\u4E2A\u95EA\u7535\u8282\u70B9\u3001\u6BCF\u4E2A\u56FD\u5BB6\u7684\u603B BTC \u5BB9\u91CF\u7B49\u7B49\u3002");
    ...
    generateChartSerieData(country) {
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${country.name.en} (${country.share}%)</b><br>` + "" + nodeCount + "\u4E2A\u8282\u70B9" + `<br>` + "" + this.amountShortenerPipe.transform(country.capacity / 100000000, 2) + "BTC \u5BB9\u91CF";
            }
          },
          data: country.iso
        });
      ...
      data.push({
        ...
        name: "\u5176\u4ED6\uFF08" + (totalShareOther.toFixed(2) + '%') + "\uFF09",
        label: {
          overflow: 'truncate',
          color: 'var(--tooltip-grey)',
          alignTo: 'edge',
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "\u5176\u4ED6\uFF08" + (totalShareOther.toFixed(2) + '%') + "\uFF09" + `</b><br>` + "" + nodeCount + "\u4E2A\u8282\u70B9";
          }
        },
        data: 9999
      });
  ...
  class NodesPerCountry {
    ...
    ngOnInit() {
      this.nodes$ = this.apiService.getNodeForCountry$(this.route.snapshot.params.country).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_11__.tap)(() => this.isLoading = true), (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.map)(response => {
        this.seoService.setTitle("\u95EA\u7535\u7F51\u7EDC\u8282\u70B9\u4F4D\u4E8E" + response.country.en + "");
        this.seoService.setDescription("\u63A2\u7D22 " + response.country.en + " \u4E2D\u6258\u7BA1\u7684\u6240\u6709 Lightning \u8282\u70B9\uFF0C\u5E76\u67E5\u770B\u6BCF\u4E2A\u8282\u70B9\u7684\u5BB9\u91CF\u3001\u5F00\u653E\u901A\u9053\u6570\u91CF\u7B49\u6982\u89C8\u3002");
        this.country = {
...
let NodesPerISPChartComponent = /*#__PURE__*/(() => {
  class NodesPerISPChartComponent {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("\u95EA\u7535\u7F51\u7EDC\u8282\u70B9\u6309 ISP \u6392\u5E8F");
        this.seoService.setDescription("\u6D4F\u89C8\u6258\u7BA1\u95EA\u7535\u8282\u70B9\u7684\u524D 100 \u5BB6 ISP\uFF0C\u4EE5\u53CA\u6BCF\u4E2A ISP \u7684\u8282\u70B9\u603B\u6570\u3001\u6BCF\u4E2A ISP \u7684 BTC \u603B\u5BB9\u91CF\u7B49\u7EDF\u8BA1\u6570\u636E");
      }
        ...
        data.push({
          ...
          tooltip: {
            ...
            formatter: () => {
              ...
              return `<b style="color: white">${isp[1]} (${this.sortBy === 'capacity' ? isp[7] : isp[6]}%)</b><br>` + "" + nodeCount + "\u4E2A\u8282\u70B9" + `<br>` + "" + this.amountShortenerPipe.transform(isp[2] / 100000000, 2) + " BTC";
            }
          },
          data: isp[0]
        });
      ...
      data.push({
        ...
        tooltip: {
          ...
          formatter: () => {
            ...
            return `<b style="color: white">` + "\u5176\u4ED6\uFF08" + (totalShareOther.toFixed(2) + '%') + "\uFF09" + `</b><br>` + "" + nodeCount + "\u4E2A\u8282\u70B9" + `<br>` + "" + this.amountShortenerPipe.transform(capacityOther / 100000000, 2) + " BTC";
          }
        },
        data: 9999
      });
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          ...
          i18n_0 = "\u5BF9\u5916\u516C\u5E03\u81F3\u5C11\u4E00\u4E2A\u516C\u7F51 IP \u5730\u5740\u7684\u8282\u70B9\u6240\u63D0\u4F9B\u7684\u6D41\u52A8\u6027";
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_1 = "\u6CA1\u6709\u8BC6\u522B\u51FA\u6709\u6548\u7684 ISP \u4FE1\u606F\u7684\u8282\u70B9\u6240\u63D0\u4F9B\u7684\u6D41\u52A8\u6027";
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
          ...
          i18n_2 = "\u5BF9\u5916\u4EC5\u516C\u5E03 Tor \u7F51\u7EDC\u5730\u5740\u7684\u8282\u70B9\u6240\u63D0\u4F9B\u7684\u6D41\u52A8\u6027";
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          /**
  ...
  class NodesPerISPPreview {
    ...
    ngOnInit() {
      this.nodes$ = this.route.paramMap.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_10__.switchMap)(params => {
        ...
        this.seoService.setTitle("\u95EA\u7535\u7F51\u7EDC\u8282\u70B9\u4F4D\u4E8E ISP\uFF1A" + response.isp + "[AS " + this.route.snapshot.params.isp + "]");
        this.seoService.setDescription("\u4F7F\u7528 " + response.isp + " [AS" + this.route.snapshot.params.isp + "] ISP \u6D4F\u89C8\u6240\u6709\u6BD4\u7279\u5E01\u95EA\u7535\u8282\u70B9\uFF0C\u5E76\u67E5\u770B ISP \u7684\u8282\u70B9\u603B\u6570\u3001\u603B\u5BB9\u91CF\u7B49\u6C47\u603B\u7EDF\u8BA1\u6570\u636E\u3002");
        for (const i in response.nodes) {
          response.nodes[i].geolocation = {
            country: response.nodes[i].country?.en,
            city: response.nodes[i].city?.en,
...
let OldestNodes = /*#__PURE__*/(() => {
  class OldestNodes {
    ...
    ngOnInit() {
      if (!this.widget) {
        this.seoService.setTitle("\u6700\u8001\u7684\u95EA\u7535\u7F51\u7EDC\u8282\u70B9");
        this.seoService.setDescription("\u67E5\u770B\u95EA\u7535\u7F51\u7EDC\u4E0A\u6700\u53E4\u8001\u7684\u8282\u70B9\u53CA\u5176\u5BB9\u91CF\u3001\u901A\u9053\u6570\u91CF\u3001\u4F4D\u7F6E\u7B49\u3002");
      }
...
let TopNodesPerCapacity = /*#__PURE__*/(() => {
  class TopNodesPerCapacity {
    ...
    ngOnInit() {
      ...
      if (!this.widget) {
        this.seoService.setTitle("\u6D41\u901A\u91CF\u6392\u540D");
        this.seoService.setDescription("\u67E5\u770B\u90E8\u7F72\u4E86\u6700\u591A BTC \u6D41\u52A8\u6027\u7684\u95EA\u7535\u8282\u70B9\u4EE5\u53CA\u5F00\u653E\u901A\u9053\u6570\u91CF\u3001\u4F4D\u7F6E\u3001\u8282\u70B9\u5E74\u9F84\u7B49\u9AD8\u7EA7\u7EDF\u8BA1\u6570\u636E\u3002");
      }
...
let TopNodesPerChannels = /*#__PURE__*/(() => {
  class TopNodesPerChannels {
    ...
    ngOnInit() {
      ...
      if (this.widget === false) {
        this.seoService.setTitle("\u53EF\u8FDE\u63A5\u6027\u6392\u540D");
        this.seoService.setDescription("\u67E5\u770B\u5F00\u653E\u901A\u9053\u6700\u591A\u7684\u95EA\u7535\u8282\u70B9\u4EE5\u53CA\u8282\u70B9\u603B\u5BB9\u91CF\u3001\u8282\u70B9\u8FD0\u884C\u65F6\u957F\u7B49\u9AD8\u7EA7\u7EDF\u8BA1\u6570\u636E\u3002");
...
let NodesRankingsDashboard = /*#__PURE__*/(() => {
  class NodesRankingsDashboard {
    ...
    ngOnInit() {
      this.seoService.setTitle("Top \u95EA\u7535\u7F51\u7EDC\u8282\u70B9");
      this.seoService.setDescription("\u67E5\u770B\u6309\u6D41\u52A8\u6027\u3001\u8FDE\u63A5\u6027\u548C\u8FD0\u884C\u65F6\u95F4\u6392\u540D\u7684\u9876\u7EA7\u95EA\u7535\u7F51\u7EDC\u8282\u70B9\u3002");
  ...
  class LightningStatisticsChartComponent {
    ...
    ngOnInit() {
      ...
      if (this.widget) {
        ...
        this.seoService.setTitle("\u95EA\u7535\u7F51\u7EDC\u5BB9\u91CF");
        this.seoService.setDescription("\u4EE5\u5F00\u653E\u901A\u9053\u6570\u91CF\u548C\u6BD4\u7279\u5E01\u603B\u5BB9\u91CF\u7684\u5F62\u5F0F\uFF0C\u67E5\u770B\u95EA\u7535\u7F51\u7EDC\u968F\u65F6\u95F4\u53D8\u5316\u7684\u5BB9\u91CF\u3002");
        this.miningWindowPreference = this.miningService.getDefaultTimespan('all');
      }
      this.radioGroupForm = this.formBuilder.group({
        dateSpan: this.miningWindowPreference
